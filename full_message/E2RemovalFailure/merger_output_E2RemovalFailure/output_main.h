...
typedef struct EXTERN e2ap_E2RemovalFailure_protocolIEs_element {
   ...
   struct{
      ...
      union {
        ...
        *presence: MANDATORY
        */
        e2ap_TransactionID *_e2apE2RemovalFailure_id_TransactionID,
        ...
        *presence: MANDATORY
        */
        e2ap_Cause *_e2apE2RemovalFailure_id_Cause,
        ...
        *presence: MANDATORY
        */
        e2ap_CriticalityDiagnostics *_e2apE2RemovalFailure_id_CriticalityDiagnostics
