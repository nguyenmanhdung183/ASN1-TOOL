...
/******************************************************/
/* File .c missing: e2ap_E2connectionUpdate_ItemIEs.c */
/******************************************************/
...
/************************************************************/
/* File .c missing: e2ap_E2connectionUpdateRemove_ItemIEs.c */
/************************************************************/
...
// --- Begin of e2ap_E2connectionUpdateRemove_Item_protocolIEs.c ---
/******************************************************/
/*                                                    */
...
EXTERN int asn1PE_e2ap_E2connectionUpdateRemove-Item_protocolIEs (OSCTXT* pctxt, e2ap_E2connectionUpdateRemove-Item_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
    ...
    for(pnode = pvalue->head; pnode != 0 && xx1<pvalue->count; pnode = pnode->next){
        ...
        stat = asn1PE_e2ap_E2connectionUpdateRemove-Item_protocolIEs_element (pctxt, ((e2ap_E2connectionUpdateRemove-Item_protocolIEs_element*)pnode->data));
        if(stat!=0) return LOG_RTERR(pctxt, stat);
        xx1++;
...
EXTERN int  asn1PD_e2ap_E2connectionUpdateRemove-Item_protocolIEs(OSCTXT* pctxt, e2ap_E2connectionUpdateRemove-Item_protocolIEs* pvalue)
{
    ...
    for(xx1=0; xx1 < count; xx1++){
        e2ap_E2connectionUpdateRemove-Item_protocolIEs_element* pdata;
        RTXCTXTPUSHARRAYELEMNAME(pctxt, "SEQUENCE", &pnode, &pdata);

        if(pnode == NULL) return LOG_RTERR(pctxt, RTERR_NOMEM);

        asn1Init_e2ap_E2connectionUpdateRemove-Item_protocolIEs_element(pdata);
        rtxDListAppendNode(pvalue, pnode);
       // stat = asn1PD_e2ap_E2connectionUpdateRemove-Item_protocolIEs_element (pctxt, pdata);
        if(stat!=0) return LOG_RTERR(pctxt, stat);
        RTXCTXTPOPARRAYELEMNAME(pctxt);
...
int asn1Init_e2ap_E2connectionUpdateRemove-Item_protocolIEs(e2ap_E2connectionUpdateRemove-Item_protocolIEs* pvalue)
{
    if(0==pvalue) return RTERR_NULLPTR;
    rtxDListFastInit (pvalue);
    return 0;
...
void asn1Free_e2ap_E2connectionUpdateRemove-Item_protocolIEs(OSCTXT* pctxt, e2ap_E2connectionUpdateRemove-Item_protocolIEs* pvalue)
{
    if(0==pvalue) return;   
    e2ap_E2connectionUpdateRemove-Item_protocolIEs_element* pdata;
    OSRTDListNode* pnode=pvalue->head;
    while(0!=pnode){
        pdata = (e2ap_E2connectionUpdateRemove-Item_protocolIEs_element*)pnode->data;
       // asn1Free_e2ap_E2connectionUpdateRemove-Item_protocolIEs_element(pctxt, pdata);
        pnode = pnode->next;
    }
    rtxDListFreeAll(pctxt, pvalue);
}

// --- End of e2ap_E2connectionUpdateRemove_Item_protocolIEs.c ---

// --- Begin of e2ap_E2connectionUpdate_Item_protocolIEs.c ---
/******************************************************/
/*                                                    */
...
EXTERN int asn1PE_e2ap_E2connectionUpdate-Item_protocolIEs (OSCTXT* pctxt, e2ap_E2connectionUpdate-Item_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
    ...
    for(pnode = pvalue->head; pnode != 0 && xx1<pvalue->count; pnode = pnode->next){
        RTXCTXTPUSHARRAYELEMNAME(pctxt, "SEQUENCE", xx1);
        stat = asn1PE_e2ap_E2connectionUpdate-Item_protocolIEs_element (pctxt, ((e2ap_E2connectionUpdate-Item_protocolIEs_element*)pnode->data));
        if(stat!=0) return LOG_RTERR(pctxt, stat);
        xx1++;
        RTXCTXTPOPARRAYELEMNAME(pctxt);
    }
...
EXTERN int  asn1PD_e2ap_E2connectionUpdate-Item_protocolIEs(OSCTXT* pctxt, e2ap_E2connectionUpdate-Item_protocolIEs* pvalue)
{
    ...
    for(xx1=0; xx1 < count; xx1++){
        e2ap_E2connectionUpdate-Item_protocolIEs_element* pdata;
        RTXCTXTPUSHARRAYELEMNAME(pctxt, "SEQUENCE", &pnode, &pdata);

        if(pnode == NULL) return LOG_RTERR(pctxt, RTERR_NOMEM);

        asn1Init_e2ap_E2connectionUpdate-Item_protocolIEs_element(pdata);
        rtxDListAppendNode(pvalue, pnode);
       // stat = asn1PD_e2ap_E2connectionUpdate-Item_protocolIEs_element (pctxt, pdata);
        if(stat!=0) return LOG_RTERR(pctxt, stat);
        RTXCTXTPOPARRAYELEMNAME(pctxt);
...
int asn1Init_e2ap_E2connectionUpdate-Item_protocolIEs(e2ap_E2connectionUpdate-Item_protocolIEs* pvalue)
{
    if(0==pvalue) return RTERR_NULLPTR;
    rtxDListFastInit (pvalue);
    return 0;
...
void asn1Free_e2ap_E2connectionUpdate-Item_protocolIEs(OSCTXT* pctxt, e2ap_E2connectionUpdate-Item_protocolIEs* pvalue)
{
    if(0==pvalue) return;   
    e2ap_E2connectionUpdate-Item_protocolIEs_element* pdata;
    OSRTDListNode* pnode=pvalue->head;
    while(0!=pnode){
        pdata = (e2ap_E2connectionUpdate-Item_protocolIEs_element*)pnode->data;
       // asn1Free_e2ap_E2connectionUpdate-Item_protocolIEs_element(pctxt, pdata);
        pnode = pnode->next;
    }
    rtxDListFreeAll(pctxt, pvalue);
}

// --- End of e2ap_E2connectionUpdate_Item_protocolIEs.c ---
        ...
        
    {
        ...
        switch(pvalue->value.t){
            ...
            case T_E2AP_PDU_Contents_e2ap_E2connectionUpdate_ItemIEs_id_E2connectionUpdate_Item:
            {
                ...
                stat = asn1PE_e2ap_TransactionID (pctxt, pvalue->value.u._e2ap_E2SetupRequestIEs_id_E2connectionUpdate_Item);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_E2connectionUpdateRemove_ItemIEs_id_E2connectionUpdateRemove_Item:
            {
                ...
                stat = asn1PE_e2ap_TransactionID (pctxt, pvalue->value.u._e2ap_E2SetupRequestIEs_id_E2connectionUpdateRemove_Item);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
...
EXTERN int  asn1PD_e2ap_E2connectionUpdate_protocolIEs_element (OSCTXT* pctxt, e2ap_E2connectionUpdate_protocolIEs_element* pvalue){
...

    {
        ...
        switch(pvalue->id){
            ...
            asn1Init_e2ap_E2connectionUpdate_Item(pvalue->
                value.u._e2ap_E2connectionUpdate_ItemIEs_id_E2connectionUpdate_Item);

            stat = asn1PD_e2ap_E2connectionUpdate_Item (pctxt,
                (e2ap_E2connectionUpdate_Item*)pvalue->value.
                u._e2ap_E2connectionUpdate_ItemIEs_id_E2connectionUpdate_Item);
            if(stat!=0) return LOG_RTERR(pctxt, stat);
            RTXCTXTPOPELEMNAME(pctxt);
            break;
            ...
            asn1Init_e2ap_E2connectionUpdateRemove_Item(pvalue->
                value.u._e2ap_E2connectionUpdateRemove_ItemIEs_id_E2connectionUpdateRemove_Item);

            stat = asn1PD_e2ap_E2connectionUpdateRemove_Item (pctxt,
                (e2ap_E2connectionUpdateRemove_Item*)pvalue->value.
                u._e2ap_E2connectionUpdateRemove_ItemIEs_id_E2connectionUpdateRemove_Item);
            if(stat!=0) return LOG_RTERR(pctxt, stat);
            RTXCTXTPOPELEMNAME(pctxt);
            break;
...
void free_e2ap_E2connectionUpdate_protocolIEs_element(e2ap_E2connectionUpdate_protocolIEs_element* pvalue)
{
    ...
    switch(pvalue->value.t){
        ...
        case T_E2AP_PDU_Contents_e2ap_E2connectionUpdate_IEs_id_E2connectionUpdate_List:
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_E2connectionUpdate_ItemIEs_id_E2connectionUpdate_Item:
            rtxFreeE2ap_E2connectionUpdate_Item(pvalue->value.u._e2ap_E2connectionUpdate_ItemIEs_id_E2connectionUpdate_Item);
            break;
        case T_E2AP_PDU_Contents_e2ap_E2connectionUpdateRemove_ItemIEs_id_E2connectionUpdateRemove_Item:
            rtxFreeE2ap_E2connectionUpdateRemove_Item(pvalue->value.u._e2ap_E2connectionUpdateRemove_ItemIEs_id_E2connectionUpdateRemove_Item);
            break;
        case T_E2AP_PDU_Contents_e2ap_E2connectionUpdate_IEs_UNDEF_:
    ...
    RTXCTXTPUSHELEMNAME(pctxt, "value");
        ...
        switch(pvalue->value.t){
            ...
            case T_E2AP_PDU_Contents_e2ap_E2connectionUpdate_ItemIEs_id_E2connectionUpdate_Item:
            {
                ...
                stat = asn1PrtToStr_e2ap_E2connectionUpdate_Item (pctxt, pvalue->value.u._e2ap_E2connectionUpdate_ItemIEs_id_E2connectionUpdate_Item);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_E2connectionUpdateRemove_ItemIEs_id_E2connectionUpdateRemove_Item:
            {
                ...
                stat = asn1PrtToStr_e2ap_E2connectionUpdateRemove_Item (pctxt, pvalue->value.u._e2ap_E2connectionUpdateRemove_ItemIEs_id_E2connectionUpdateRemove_Item);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
