...
typedef struct EXTERN e2ap_E2connectionUpdateFailure_protocolIEs_element {
   ...
   struct{
      ...
      union {
        ...
        *presence: MANDATORY
        */
        e2ap_TransactionID *_e2apE2connectionUpdateFailure_id_TransactionID,
        ...
        *presence: MANDATORY
        */
        e2ap_Cause *_e2apE2connectionUpdateFailure_id_Cause,
        ...
        *presence: MANDATORY
        */
        e2ap_TimeToWait *_e2apE2connectionUpdateFailure_id_TimeToWait,
        ...
        *presence: MANDATORY
        */
        e2ap_CriticalityDiagnostics *_e2apE2connectionUpdateFailure_id_CriticalityDiagnostics
