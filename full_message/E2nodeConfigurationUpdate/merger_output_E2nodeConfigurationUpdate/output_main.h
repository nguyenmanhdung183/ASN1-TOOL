...
typedef struct EXTERN e2ap_E2nodeComponentConfigRemoval_ItemIEs {
   ...
   struct{
      ...
      union {
         e2ap_E2nodeComponentConfigRemoval-Item * _e2apE2nodeComponentConfigRemoval_ItemIEs_E2nodeComponentConfigRemoval_Item
...
typedef struct EXTERN e2ap_E2nodeTNLassociationRemoval_ItemIEs {
   ...
   struct{
      ...
      union {
         e2ap_E2nodeTNLassociationRemoval-Item * _e2apE2nodeTNLassociationRemoval_ItemIEs_E2nodeTNLassociationRemoval_Item
