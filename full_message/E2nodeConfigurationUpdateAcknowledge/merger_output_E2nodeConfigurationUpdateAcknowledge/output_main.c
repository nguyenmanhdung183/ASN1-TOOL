...
int asn1PE_e2ap_E2nodeComponentConfigUpdateAck_ItemIEs (OSCTXT* pctxt, e2ap_E2nodeComponentConfigUpdateAck_ItemIEs* pvalue)
{
...

   {
      ...
      switch (pvalue->value.t) {
      case T_E2AP_PDU_Contents_E2nodeComponentConfigUpdateAck_ItemIEs_E2nodeComponentConfigUpdateAck_Item:
         
         RTXCTXTPUSHELEMNAME (pctxt, "E2nodeComponentConfigUpdateAck_Item");
         stat = asn1PE_e2ap_E2nodeComponentConfigUpdateAck_Item (pctxt, pvalue->value.u._e2apE2nodeComponentConfigUpdateAck_ItemIEs_E2nodeComponentConfigUpdateAck_Item);
         RTXCTXTPOPELEMNAME (pctxt);
...
int asn1PE_e2ap_E2nodeComponentConfigRemovalAck_ItemIEs (OSCTXT* pctxt, e2ap_E2nodeComponentConfigRemovalAck_ItemIEs* pvalue)
{
...

   {
      ...
      switch (pvalue->value.t) {
      case T_E2AP_PDU_Contents_E2nodeComponentConfigRemovalAck_ItemIEs_E2nodeComponentConfigRemovalAck_Item:
         
         RTXCTXTPUSHELEMNAME (pctxt, "E2nodeComponentConfigRemovalAck_Item");
         stat = asn1PE_e2ap_E2nodeComponentConfigRemovalAck_Item (pctxt, pvalue->value.u._e2apE2nodeComponentConfigRemovalAck_ItemIEs_E2nodeComponentConfigRemovalAck_Item);
         RTXCTXTPOPELEMNAME (pctxt);
...
EXTERN int asn1PE_e2ap_E2nodeConfigurationUpdateAcknowledge_protocolIEs (OSCTXT* pctxt, e2ap_E2nodeConfigurationUpdateAcknowledge_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
