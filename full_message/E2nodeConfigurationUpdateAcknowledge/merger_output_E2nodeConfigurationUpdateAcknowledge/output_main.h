...
typedef struct EXTERN e2ap_E2nodeComponentConfigUpdateAck_ItemIEs {
   ...
   struct{
      ...
      union {
         e2ap_E2nodeComponentConfigUpdateAck-Item * _e2apE2nodeComponentConfigUpdateAck_ItemIEs_E2nodeComponentConfigUpdateAck_Item
...
typedef struct EXTERN e2ap_E2nodeComponentConfigRemovalAck_ItemIEs {
   ...
   struct{
      ...
      union {
         e2ap_E2nodeComponentConfigRemovalAck-Item * _e2apE2nodeComponentConfigRemovalAck_ItemIEs_E2nodeComponentConfigRemovalAck_Item
