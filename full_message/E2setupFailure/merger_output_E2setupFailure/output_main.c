...
/*********************************************/
/* File .c missing: e2ap_E2setupFailureIEs.c */
/*********************************************/

// --- Begin of e2ap_E2setupFailure.c ---
...
// --- End of e2ap_E2setupFailure.c ---

// --- Begin of e2ap_E2setupFailure_protocolIEs.c ---
/******************************************************/
/*                                                    */
...
EXTERN int asn1PE_e2ap_E2setupFailure_protocolIEs (OSCTXT* pctxt, e2ap_E2setupFailure_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
...
// --- End of e2ap_E2setupFailure_protocolIEs.c ---

// --- Begin of e2ap_E2setupFailure_protocolIEs_element.c ---
/*****************************************/
...
void asn1Free_e2ap_E2setupFailure_protocolIEs_element(OSCTXT* pctxt, e2ap_E2setupFailure_protocolIEs_element* pvalue)
{
    ...
    switch(pvalue->value.t){
        case T_E2AP_PDU_Contents_e2ap_E2setupFailureIEs_id_TransactionID:
            ...
            if(pvalue->value.i._e2ap_E2setupFailureIEs_id_TransactionID!=NULL){
        ...
        case T_E2AP_PDU_Contents_e2ap_E2setupFailureIEs_id_Cause:
            ...
            if(pvalue->value.i._e2ap_E2setupFailureIEs_id_Cause!=NULL){
        ...
        case T_E2AP_PDU_Contents_e2ap_E2setupFailureIEs_id_TimeToWait:
            ...
            if(pvalue->value.i._e2ap_E2setupFailureIEs_id_TimeToWait!=NULL){
        ...
        case T_E2AP_PDU_Contents_e2ap_E2setupFailureIEs_id_CriticalityDiagnostics:
            ...
            if(pvalue->value.i._e2ap_E2setupFailureIEs_id_CriticalityDiagnostics!=NULL){
        ...
        case T_E2AP_PDU_Contents_e2ap_E2setupFailureIEs_id_TNLinformation:
            ...
            if(pvalue->value.i._e2ap_E2setupFailureIEs_id_TNLinformation!=NULL){
...
#endif
// --- End of e2ap_E2setupFailure_protocolIEs_element.c ---
