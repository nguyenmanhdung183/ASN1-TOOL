...
int asn1PE_e2ap_GlobalRIC_ID (OSCTXT* pctxt, e2ap_GlobalRIC_ID* pvalue)
{
   ...
   stat = pe_BitString32 (pctxt, &pvalue->ric_ID);
   if (stat != 0) return LOG_RTERR(pctxt, stat);
   RTXPOPELEMNAME(pctxt);
...
int asn1Init_e2ap_GlobalRIC_ID (e2ap_GlobalRIC_ID* pvalue)
{
   ...
   //asn1Init_ASN1BitStr32 (&pvalue->ric_ID);
...
void asn1Free_e2ap_GlobalRIC_ID (OSCTXT* pctxt, e2ap_GlobalRIC_ID* pvalue)
{
   ...
   //asn1Free_ASN1BitStr32 (pctxt, &pvalue->ric_ID);
...
int asn1PrtToStr_e2ap_GlobalRIC_ID (const char* name, e2ap_GlobalRIC_ID* pvalue, char* buffer, OSSIZE bufSize)
{
   ...
   if(asn1PrtToStr_ASN1BitStr32 ("ric_ID", &pvalue->ric_ID, buffer, bufSize) < 0)
   {
      return -1;
   }
...
int asn1PE_e2ap_E2nodeComponentConfigAdditionAck_ItemIEs (OSCTXT* pctxt, e2ap_E2nodeComponentConfigAdditionAck_ItemIEs* pvalue)
{
...

   {
      ...
      switch (pvalue->value.t) {
      case T_E2AP_PDU_Contents_E2nodeComponentConfigAdditionAck_ItemIEs_E2nodeComponentConfigAdditionAck_Item:
         
         RTXCTXTPUSHELEMNAME (pctxt, "E2nodeComponentConfigAdditionAck_Item");
...
/**********************************************/
/* File .c missing: e2ap_E2setupResponseIEs.c */
/**********************************************/
...
// --- Begin of e2ap_E2setupResponse_protocolIEs.c ---
/******************************************************/
/*                                                    */
...
EXTERN int asn1PE_e2ap_E2setupResponse_protocolIEs (OSCTXT* pctxt, e2ap_E2setupResponse_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
...
// --- End of e2ap_E2setupResponse_protocolIEs.c ---

// --- Begin of e2ap_E2setupResponse_protocolIEs_element.c ---
/*****************************************/
...

    {
        ...
        switch(pvalue->id){//dungnm23 check case lai nhe
            ...
            asn1Init_e2ap_TransactionID(pvalue->
                value.u._e2ap_E2setupResponseIEs_id_TransactionID);
            ...
            asn1Init_e2ap_GlobalRIC_ID(pvalue->
                value.u._e2ap_E2setupResponseIEs_id_GlobalRIC_ID);
            ...
            pvalue->value.t = T_E2AP_PDU_Contents_e2ap_E2setupResponseIEs_id_RANfunctionsID_List;
            RTXCTXTPUSHELEMNAME(pctxt, "id-RANfunctionsAccepted");
            pvalue->value.u._e2ap_E2setupResponseIEs_id_RANfunctionsID_List 
                = rtxMemAllocType(pctxt, e2ap_RANfunctionsID_List);

            asn1Init_e2ap_RANfunctionsID_List(pvalue->
                value.u._e2ap_E2setupResponseIEs_id_RANfunctionsID_List);

            stat = asn1PD_e2ap_RANfunctionsID_List (pctxt,
                (e2ap_RANfunctionsID_List*)pvalue->value.
                u._e2ap_E2setupResponseIEs_id_RANfunctionsID_List);
            if(stat!=0) return LOG_RTERR(pctxt, stat);
            RTXCTXTPOPELEMNAME(pctxt);
            break;
            ...
            pvalue->value.t = T_E2AP_PDU_Contents_e2ap_E2setupResponseIEs_id_RANfunctionsIDcause_List;
            RTXCTXTPUSHELEMNAME(pctxt, "id-RANfunctionsRejected");
            pvalue->value.u._e2ap_E2setupResponseIEs_id_RANfunctionsIDcause_List 
                = rtxMemAllocType(pctxt, e2ap_RANfunctionsIDcause_List);

            asn1Init_e2ap_RANfunctionsIDcause_List(pvalue->
                value.u._e2ap_E2setupResponseIEs_id_RANfunctionsIDcause_List);

            stat = asn1PD_e2ap_RANfunctionsIDcause_List (pctxt,
                (e2ap_RANfunctionsIDcause_List*)pvalue->value.
                u._e2ap_E2setupResponseIEs_id_RANfunctionsIDcause_List);
            if(stat!=0) return LOG_RTERR(pctxt, stat);
            RTXCTXTPOPELEMNAME(pctxt);
            break;
            ...
            pvalue->value.t = T_E2AP_PDU_Contents_e2ap_E2setupResponseIEs_id_E2nodeComponentConfigAdditionAck_List;
            RTXCTXTPUSHELEMNAME(pctxt, "id-E2nodeComponentConfigAdditionAck");
            pvalue->value.u._e2ap_E2setupResponseIEs_id_E2nodeComponentConfigAdditionAck_List 
            ...
            asn1Init_e2ap_E2nodeComponentConfigAdditionAck_List(pvalue->
                value.u._e2ap_E2setupResponseIEs_id_E2nodeComponentConfigAdditionAck_List);

            stat = asn1PD_e2ap_E2nodeComponentConfigAdditionAck_List (pctxt,
                (e2ap_E2nodeComponentConfigAdditionAck_List*)pvalue->value.
                u._e2ap_E2setupResponseIEs_id_E2nodeComponentConfigAdditionAck_List);
            if(stat!=0) return LOG_RTERR(pctxt, stat);
            RTXCTXTPOPELEMNAME(pctxt);
            break;
...
void asn1Free_e2ap_E2setupResponse_protocolIEs_element(OSCTXT* pctxt, e2ap_E2setupResponse_protocolIEs_element* pvalue)
{
    ...
    switch(pvalue->value.t){
        case T_E2AP_PDU_Contents_e2ap_E2setupResponseIEs_id_TransactionID:
            ...
            if(pvalue->value.i._e2ap_E2setupResponseIEs_id_TransactionID!=NULL){
        ...
        case T_E2AP_PDU_Contents_e2ap_E2setupResponseIEs_id_GlobalRIC_ID:
            ...
            if(pvalue->value.i._e2ap_E2setupResponseIEs_id_GlobalRIC_ID!=NULL){
        ...
        case T_E2AP_PDU_Contents_e2ap_E2setupResponseIEs_id_RANfunctionsID_List:
            ...
            if(pvalue->value.i._e2ap_E2setupResponseIEs_id_RANfunctionsID_List!=NULL){
        ...
        case T_E2AP_PDU_Contents_e2ap_E2setupResponseIEs_id_RANfunctionsIDcause_List:
            ...
            if(pvalue->value.i._e2ap_E2setupResponseIEs_id_RANfunctionsIDcause_List!=NULL){
        ...
        case T_E2AP_PDU_Contents_e2ap_E2setupResponseIEs_id_E2nodeComponentConfigAdditionAck_List:
            ...
            if(pvalue->value.i._e2ap_E2setupResponseIEs_id_E2nodeComponentConfigAdditionAck_List!=NULL){
...
#endif
// --- End of e2ap_E2setupResponse_protocolIEs_element.c ---
