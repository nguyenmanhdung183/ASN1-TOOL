...
/*************************************************/
/* File .c missing: e2ap_RICassistanceHalt_IEs.c */
/*************************************************/

// --- Begin of e2ap_RICassistanceHalt.c ---
...
// --- End of e2ap_RICassistanceHalt.c ---

// --- Begin of e2ap_RICassistanceHalt_protocolIEs.c ---
/******************************************************/
/*                                                    */
...
EXTERN int asn1PE_e2ap_RICassistanceHalt_protocolIEs (OSCTXT* pctxt, e2ap_RICassistanceHalt_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
...
// --- End of e2ap_RICassistanceHalt_protocolIEs.c ---

// --- Begin of e2ap_RICassistanceHalt_protocolIEs_element.c ---
/*****************************************/
/*    RICassistanceHalt_protocolIEs_element     */
/*****************************************/
...

    {
        ...
        switch(pvalue->id){//dungnm23 check case lai nhe
            ...
            asn1Init_e2ap_RICrequestID(pvalue->
                value.u._e2ap_RICassistanceHalt_IEs_id_RICrequestID);
...
void asn1Free_e2ap_RICassistanceHalt_protocolIEs_element(OSCTXT* pctxt, e2ap_RICassistanceHalt_protocolIEs_element* pvalue)
{
    ...
    switch(pvalue->value.t){
        case T_E2AP_PDU_Contents_e2ap_RICassistanceHalt_IEs_id_RICrequestID:
            // rtxFreeE2ap_RICrequestID(pvalue->value.u._e2ap_RICassistanceHalt_IEs_id_RICrequestID);

            if(pvalue->value.i._e2ap_RICassistanceHalt_IEs_id_RICrequestID!=NULL){
    ...
    RTXCTXTPUSHELEMNAME(pctxt, "value");
        ...
        switch(pvalue->value.t){
            case T_E2AP_PDU_Contents_e2ap_RICassistanceHalt_IEs_id_RICrequestID:
            {
                ...
                stat = asn1PrtToStr_e2ap_RICrequestID (pctxt, pvalue->value.u._e2ap_RICassistanceHalt_IEs_id_RICrequestID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
...
#endif
// --- End of e2ap_RICassistanceHalt_protocolIEs_element.c ---
