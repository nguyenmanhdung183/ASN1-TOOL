...
/*****************************************************/
/* File .c missing: e2ap_RICassistanceResponse_IEs.c */
/*****************************************************/

// --- Begin of e2ap_RICassistanceResponse.c ---
...
// --- End of e2ap_RICassistanceResponse.c ---

// --- Begin of e2ap_RICassistanceResponse_protocolIEs.c ---
/******************************************************/
/*                                                    */
...
EXTERN int asn1PE_e2ap_RICassistanceResponse_protocolIEs (OSCTXT* pctxt, e2ap_RICassistanceResponse_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
...
// --- End of e2ap_RICassistanceResponse_protocolIEs.c ---

// --- Begin of e2ap_RICassistanceResponse_protocolIEs_element.c ---
/*****************************************/
...

    {
        ...
        switch(pvalue->id){//dungnm23 check case lai nhe
            ...
            asn1Init_e2ap_RICrequestID(pvalue->
                value.u._e2ap_RICassistanceResponse_IEs_id_RICrequestID);
            ...
            asn1Init_e2ap_RICassistanceHeader(pvalue->
                value.u._e2ap_RICassistanceResponse_IEs_id_RICassistanceHeader);
            ...
            asn1Init_e2ap_RICassistanceOutcome(pvalue->
                value.u._e2ap_RICassistanceResponse_IEs_id_RICassistanceOutcome);
...
void asn1Free_e2ap_RICassistanceResponse_protocolIEs_element(OSCTXT* pctxt, e2ap_RICassistanceResponse_protocolIEs_element* pvalue)
{
    ...
    switch(pvalue->value.t){
        case T_E2AP_PDU_Contents_e2ap_RICassistanceResponse_IEs_id_RICrequestID:
            // rtxFreeE2ap_RICrequestID(pvalue->value.u._e2ap_RICassistanceResponse_IEs_id_RICrequestID);

            if(pvalue->value.i._e2ap_RICassistanceResponse_IEs_id_RICrequestID!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICassistanceResponse_IEs_id_RICassistanceHeader:
            // rtxFreeE2ap_RICassistanceHeader(pvalue->value.u._e2ap_RICassistanceResponse_IEs_id_RICassistanceHeader);

            if(pvalue->value.i._e2ap_RICassistanceResponse_IEs_id_RICassistanceHeader!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICassistanceResponse_IEs_id_RICassistanceOutcome:
            // rtxFreeE2ap_RICassistanceOutcome(pvalue->value.u._e2ap_RICassistanceResponse_IEs_id_RICassistanceOutcome);

            if(pvalue->value.i._e2ap_RICassistanceResponse_IEs_id_RICassistanceOutcome!=NULL){
    ...
    RTXCTXTPUSHELEMNAME(pctxt, "value");
        ...
        switch(pvalue->value.t){
            case T_E2AP_PDU_Contents_e2ap_RICassistanceResponse_IEs_id_RICrequestID:
            {
                ...
                stat = asn1PrtToStr_e2ap_RICrequestID (pctxt, pvalue->value.u._e2ap_RICassistanceResponse_IEs_id_RICrequestID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICassistanceResponse_IEs_id_RICassistanceHeader:
            {
                ...
                stat = asn1PrtToStr_e2ap_RICassistanceHeader (pctxt, pvalue->value.u._e2ap_RICassistanceResponse_IEs_id_RICassistanceHeader);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICassistanceResponse_IEs_id_RICassistanceOutcome:
            {
                ...
                stat = asn1PrtToStr_e2ap_RICassistanceOutcome (pctxt, pvalue->value.u._e2ap_RICassistanceResponse_IEs_id_RICassistanceOutcome);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
...
#endif
// --- End of e2ap_RICassistanceResponse_protocolIEs_element.c ---
