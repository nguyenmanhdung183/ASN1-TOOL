...
/*****************************************************/
/* File .c missing: e2ap_RICcontrolAcknowledge_IEs.c */
/*****************************************************/

// --- Begin of e2ap_RICcontrolAcknowledge.c ---
...
// --- End of e2ap_RICcontrolAcknowledge.c ---

// --- Begin of e2ap_RICcontrolAcknowledge_protocolIEs.c ---
/******************************************************/
/*                                                    */
...
EXTERN int asn1PE_e2ap_RICcontrolAcknowledge_protocolIEs (OSCTXT* pctxt, e2ap_RICcontrolAcknowledge_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
...
// --- End of e2ap_RICcontrolAcknowledge_protocolIEs.c ---

// --- Begin of e2ap_RICcontrolAcknowledge_protocolIEs_element.c ---
/*****************************************/
...

    {
        ...
        switch(pvalue->id){//dungnm23 check case lai nhe
            ...
            asn1Init_e2ap_RICrequestID(pvalue->
                value.u._e2ap_RICcontrolAcknowledge_IEs_id_RICrequestID);
            ...
            asn1Init_e2ap_RANfunctionID(pvalue->
                value.u._e2ap_RICcontrolAcknowledge_IEs_id_RANfunctionID);
            ...
            asn1Init_e2ap_RICcallProcessID(pvalue->
                value.u._e2ap_RICcontrolAcknowledge_IEs_id_RICcallProcessID);
            ...
            asn1Init_e2ap_RICcontrolOutcome(pvalue->
                value.u._e2ap_RICcontrolAcknowledge_IEs_id_RICcontrolOutcome);
...
void asn1Free_e2ap_RICcontrolAcknowledge_protocolIEs_element(OSCTXT* pctxt, e2ap_RICcontrolAcknowledge_protocolIEs_element* pvalue)
{
    ...
    switch(pvalue->value.t){
        case T_E2AP_PDU_Contents_e2ap_RICcontrolAcknowledge_IEs_id_RICrequestID:
            // rtxFreeE2ap_RICrequestID(pvalue->value.u._e2ap_RICcontrolAcknowledge_IEs_id_RICrequestID);

            if(pvalue->value.i._e2ap_RICcontrolAcknowledge_IEs_id_RICrequestID!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICcontrolAcknowledge_IEs_id_RANfunctionID:
            // rtxFreeE2ap_RANfunctionID(pvalue->value.u._e2ap_RICcontrolAcknowledge_IEs_id_RANfunctionID);

            if(pvalue->value.i._e2ap_RICcontrolAcknowledge_IEs_id_RANfunctionID!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICcontrolAcknowledge_IEs_id_RICcallProcessID:
            // rtxFreeE2ap_RICcallProcessID(pvalue->value.u._e2ap_RICcontrolAcknowledge_IEs_id_RICcallProcessID);

            if(pvalue->value.i._e2ap_RICcontrolAcknowledge_IEs_id_RICcallProcessID!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICcontrolAcknowledge_IEs_id_RICcontrolOutcome:
            // rtxFreeE2ap_RICcontrolOutcome(pvalue->value.u._e2ap_RICcontrolAcknowledge_IEs_id_RICcontrolOutcome);

            if(pvalue->value.i._e2ap_RICcontrolAcknowledge_IEs_id_RICcontrolOutcome!=NULL){
    ...
    RTXCTXTPUSHELEMNAME(pctxt, "value");
        ...
        switch(pvalue->value.t){
            case T_E2AP_PDU_Contents_e2ap_RICcontrolAcknowledge_IEs_id_RICrequestID:
            {
                ...
                stat = asn1PrtToStr_e2ap_RICrequestID (pctxt, pvalue->value.u._e2ap_RICcontrolAcknowledge_IEs_id_RICrequestID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICcontrolAcknowledge_IEs_id_RANfunctionID:
            {
                ...
                stat = asn1PrtToStr_e2ap_RANfunctionID (pctxt, pvalue->value.u._e2ap_RICcontrolAcknowledge_IEs_id_RANfunctionID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICcontrolAcknowledge_IEs_id_RICcallProcessID:
            {
                ...
                stat = asn1PrtToStr_e2ap_RICcallProcessID (pctxt, pvalue->value.u._e2ap_RICcontrolAcknowledge_IEs_id_RICcallProcessID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICcontrolAcknowledge_IEs_id_RICcontrolOutcome:
            {
                ...
                stat = asn1PrtToStr_e2ap_RICcontrolOutcome (pctxt, pvalue->value.u._e2ap_RICcontrolAcknowledge_IEs_id_RICcontrolOutcome);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
...
#endif
// --- End of e2ap_RICcontrolAcknowledge_protocolIEs_element.c ---
