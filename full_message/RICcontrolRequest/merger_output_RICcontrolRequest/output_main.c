...
// --- Begin of e2ap_RICcontrolHeader.c ---
/*****************************************/
/*           RICcontrolHeader                */
/*****************************************/
//octet string
...
/* Print to string */
int asn1PrtToStr_e2ap_RICcontrolHeader (const char* name, e2ap_RICcontrolHeader* pvalue, char* buffer, OSSIZE bufSize)
{
   if (rtPrintToStringIndent (buffer, bufSize) < 0) {
      return -1;
   }
...
// --- End of e2ap_RICcontrolHeader.c ---

// --- Begin of e2ap_RICcontrolMessage.c ---
/*****************************************/
/*           RICcontrolMessage                */
/*****************************************/
//octet string
...
/* Print to string */
int asn1PrtToStr_e2ap_RICcontrolMessage (const char* name, e2ap_RICcontrolMessage* pvalue, char* buffer, OSSIZE bufSize)
{
   if (rtPrintToStringIndent (buffer, bufSize) < 0) {
      return -1;
   }
...
// --- End of e2ap_RICcontrolMessage.c ---

// --- Begin of e2ap_RICcontrolAckRequest.c ---
/******************************************************/
/*                                                    */
...
EXTERN int asn1PrtToStr_e2ap_RICcontrolAckRequest (const char* name, e2ap_RICcontrolAckRequest* pvalue, char* buffer, OSSIZE bufSize)
{
   ...
   switch(*pvalue) {
      case 0:
         stat = rtPrintToString(" = noAck", buffer, bufSize);
         break;
      case 1:
         stat = rtPrintToString(" = ack", buffer, bufSize);
         break;
      default:
...
// --- End of e2ap_RICcontrolAckRequest.c ---

/*************************************************/
/* File .c missing: e2ap_RICcontrolRequest_IEs.c */
/*************************************************/

// --- Begin of e2ap_RICcontrolRequest.c ---
...
// --- End of e2ap_RICcontrolRequest.c ---

// --- Begin of e2ap_RICcontrolRequest_protocolIEs.c ---
/******************************************************/
/*                                                    */
...
EXTERN int asn1PE_e2ap_RICcontrolRequest_protocolIEs (OSCTXT* pctxt, e2ap_RICcontrolRequest_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
...
// --- End of e2ap_RICcontrolRequest_protocolIEs.c ---

// --- Begin of e2ap_RICcontrolRequest_protocolIEs_element.c ---
/*****************************************/
...

    {
        ...
        switch(pvalue->id){//dungnm23 check case lai nhe
            ...
            asn1Init_e2ap_RICrequestID(pvalue->
                value.u._e2ap_RICcontrolRequest_IEs_id_RICrequestID);
            ...
            asn1Init_e2ap_RANfunctionID(pvalue->
                value.u._e2ap_RICcontrolRequest_IEs_id_RANfunctionID);
            ...
            asn1Init_e2ap_RICcallProcessID(pvalue->
                value.u._e2ap_RICcontrolRequest_IEs_id_RICcallProcessID);
            ...
            asn1Init_e2ap_RICcontrolHeader(pvalue->
                value.u._e2ap_RICcontrolRequest_IEs_id_RICcontrolHeader);
            ...
            asn1Init_e2ap_RICcontrolMessage(pvalue->
                value.u._e2ap_RICcontrolRequest_IEs_id_RICcontrolMessage);
            ...
            asn1Init_e2ap_RICcontrolAckRequest(pvalue->
                value.u._e2ap_RICcontrolRequest_IEs_id_RICcontrolAckRequest);
...
void asn1Free_e2ap_RICcontrolRequest_protocolIEs_element(OSCTXT* pctxt, e2ap_RICcontrolRequest_protocolIEs_element* pvalue)
{
    ...
    switch(pvalue->value.t){
        case T_E2AP_PDU_Contents_e2ap_RICcontrolRequest_IEs_id_RICrequestID:
            // rtxFreeE2ap_RICrequestID(pvalue->value.u._e2ap_RICcontrolRequest_IEs_id_RICrequestID);

            if(pvalue->value.i._e2ap_RICcontrolRequest_IEs_id_RICrequestID!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICcontrolRequest_IEs_id_RANfunctionID:
            // rtxFreeE2ap_RANfunctionID(pvalue->value.u._e2ap_RICcontrolRequest_IEs_id_RANfunctionID);

            if(pvalue->value.i._e2ap_RICcontrolRequest_IEs_id_RANfunctionID!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICcontrolRequest_IEs_id_RICcallProcessID:
            // rtxFreeE2ap_RICcallProcessID(pvalue->value.u._e2ap_RICcontrolRequest_IEs_id_RICcallProcessID);

            if(pvalue->value.i._e2ap_RICcontrolRequest_IEs_id_RICcallProcessID!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICcontrolRequest_IEs_id_RICcontrolHeader:
            // rtxFreeE2ap_RICcontrolHeader(pvalue->value.u._e2ap_RICcontrolRequest_IEs_id_RICcontrolHeader);

            if(pvalue->value.i._e2ap_RICcontrolRequest_IEs_id_RICcontrolHeader!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICcontrolRequest_IEs_id_RICcontrolMessage:
            // rtxFreeE2ap_RICcontrolMessage(pvalue->value.u._e2ap_RICcontrolRequest_IEs_id_RICcontrolMessage);

            if(pvalue->value.i._e2ap_RICcontrolRequest_IEs_id_RICcontrolMessage!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICcontrolRequest_IEs_id_RICcontrolAckRequest:
            // rtxFreeE2ap_RICcontrolAckRequest(pvalue->value.u._e2ap_RICcontrolRequest_IEs_id_RICcontrolAckRequest);

            if(pvalue->value.i._e2ap_RICcontrolRequest_IEs_id_RICcontrolAckRequest!=NULL){
    ...
    RTXCTXTPUSHELEMNAME(pctxt, "value");
        ...
        switch(pvalue->value.t){
            case T_E2AP_PDU_Contents_e2ap_RICcontrolRequest_IEs_id_RICrequestID:
            {
                ...
                stat = asn1PrtToStr_e2ap_RICrequestID (pctxt, pvalue->value.u._e2ap_RICcontrolRequest_IEs_id_RICrequestID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICcontrolRequest_IEs_id_RANfunctionID:
            {
                ...
                stat = asn1PrtToStr_e2ap_RANfunctionID (pctxt, pvalue->value.u._e2ap_RICcontrolRequest_IEs_id_RANfunctionID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICcontrolRequest_IEs_id_RICcallProcessID:
            {
                ...
                stat = asn1PrtToStr_e2ap_RICcallProcessID (pctxt, pvalue->value.u._e2ap_RICcontrolRequest_IEs_id_RICcallProcessID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICcontrolRequest_IEs_id_RICcontrolHeader:
            {
                RTXCTXTPUSHELEMNAME (pctxt, "RICcontrolHeader");

                stat = asn1PrtToStr_e2ap_RICcontrolHeader (pctxt, pvalue->value.u._e2ap_RICcontrolRequest_IEs_id_RICcontrolHeader);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICcontrolRequest_IEs_id_RICcontrolMessage:
            {
                RTXCTXTPUSHELEMNAME (pctxt, "RICcontrolMessage");

                stat = asn1PrtToStr_e2ap_RICcontrolMessage (pctxt, pvalue->value.u._e2ap_RICcontrolRequest_IEs_id_RICcontrolMessage);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICcontrolRequest_IEs_id_RICcontrolAckRequest:
            {
                RTXCTXTPUSHELEMNAME (pctxt, "RICcontrolAckRequest");

                stat = asn1PrtToStr_e2ap_RICcontrolAckRequest (pctxt, pvalue->value.u._e2ap_RICcontrolRequest_IEs_id_RICcontrolAckRequest);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
...
#endif
// --- End of e2ap_RICcontrolRequest_protocolIEs_element.c ---
