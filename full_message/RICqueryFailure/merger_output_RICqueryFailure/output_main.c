...
/***********************************************/
/* File .c missing: e2ap_RICqueryFailure_IEs.c */
/***********************************************/
...
// --- Begin of e2ap_RICqueryFailure_protocolIEs.c ---
/******************************************************/
/*                                                    */
...
EXTERN int asn1PE_e2ap_RICqueryFailure_protocolIEs (OSCTXT* pctxt, e2ap_RICqueryFailure_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
...
// --- End of e2ap_RICqueryFailure_protocolIEs.c ---

// --- Begin of e2ap_RICqueryFailure_protocolIEs_element.c ---
/*****************************************/
/*    RICqueryFailure_protocolIEs_element     */
/*****************************************/
...

    {
        ...
        switch(pvalue->id){//dungnm23 check case lai nhe
            ...
            asn1Init_e2ap_RICrequestID(pvalue->
                value.u._e2ap_RICqueryFailure_IEs_id_RICrequestID);
            ...
            asn1Init_e2ap_RANfunctionID(pvalue->
                value.u._e2ap_RICqueryFailure_IEs_id_RANfunctionID);
            ...
            asn1Init_e2ap_Cause(pvalue->
                value.u._e2ap_RICqueryFailure_IEs_id_Cause);
            ...
            asn1Init_e2ap_CriticalityDiagnostics(pvalue->
                value.u._e2ap_RICqueryFailure_IEs_id_CriticalityDiagnostics);
...
void asn1Free_e2ap_RICqueryFailure_protocolIEs_element(OSCTXT* pctxt, e2ap_RICqueryFailure_protocolIEs_element* pvalue)
{
    ...
    switch(pvalue->value.t){
        case T_E2AP_PDU_Contents_e2ap_RICqueryFailure_IEs_id_RICrequestID:
            ...
            if(pvalue->value.i._e2ap_RICqueryFailure_IEs_id_RICrequestID!=NULL){
        ...
        case T_E2AP_PDU_Contents_e2ap_RICqueryFailure_IEs_id_RANfunctionID:
            ...
            if(pvalue->value.i._e2ap_RICqueryFailure_IEs_id_RANfunctionID!=NULL){
        ...
        case T_E2AP_PDU_Contents_e2ap_RICqueryFailure_IEs_id_Cause:
            ...
            if(pvalue->value.i._e2ap_RICqueryFailure_IEs_id_Cause!=NULL){
        ...
        case T_E2AP_PDU_Contents_e2ap_RICqueryFailure_IEs_id_CriticalityDiagnostics:
            ...
            if(pvalue->value.i._e2ap_RICqueryFailure_IEs_id_CriticalityDiagnostics!=NULL){
...
#endif
// --- End of e2ap_RICqueryFailure_protocolIEs_element.c ---
