...
/***********************************************/
/* File .h missing: e2ap_RICqueryFailure_IEs.h */
/***********************************************/
...
// --- Begin of e2ap_RICqueryFailure_protocolIEs.h ---
/******************************************************/
/*                                                    */
...
// --- End of e2ap_RICqueryFailure_protocolIEs.h ---

// --- Begin of e2ap_RICqueryFailure_protocolIEs_element.h ---
/*****************************************/
...
typedef struct EXTERN e2ap_RICqueryFailure_protocolIEs_element {
   ...
   struct{
      ...
      union {
        ...
        *presence: MANDATORY
        */
        e2ap_RICrequestID *_e2ap_RICqueryFailure_IEs_id_RICrequestID;
        ...
        *presence: MANDATORY
        */
        e2ap_RANfunctionID *_e2ap_RICqueryFailure_IEs_id_RANfunctionID;
        ...
        *presence: MANDATORY
        */
        e2ap_Cause *_e2ap_RICqueryFailure_IEs_id_Cause;
        ...
        *presence: OPTIONAL
        */
        e2ap_CriticalityDiagnostics *_e2ap_RICqueryFailure_IEs_id_CriticalityDiagnostics;
...
// --- End of e2ap_RICqueryFailure_protocolIEs_element.h ---
