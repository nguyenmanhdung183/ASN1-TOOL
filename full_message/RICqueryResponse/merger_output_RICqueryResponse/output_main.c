...
// --- Begin of e2ap_RICqueryOutcome.c ---
/*****************************************/
/*           RICqueryOutcome                */
/*****************************************/
//octet string
...
// --- End of e2ap_RICqueryOutcome.c ---

/************************************************/
/* File .c missing: e2ap_RICqueryResponse_IEs.c */
/************************************************/

// --- Begin of e2ap_RICqueryResponse.c ---
...
// --- End of e2ap_RICqueryResponse.c ---

// --- Begin of e2ap_RICqueryResponse_protocolIEs.c ---
/******************************************************/
/*                                                    */
/*    RICqueryResponse_protocolIEs                      */
/*                                                    */
/******************************************************/
//ie big msg

EXTERN int asn1PE_e2ap_RICqueryResponse_protocolIEs (OSCTXT* pctxt, e2ap_RICqueryResponse_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
...
// --- End of e2ap_RICqueryResponse_protocolIEs.c ---

// --- Begin of e2ap_RICqueryResponse_protocolIEs_element.c ---
/*****************************************/
/*    RICqueryResponse_protocolIEs_element     */
/*****************************************/
...

    {
        ...
        switch(pvalue->id){//dungnm23 check case lai nhe
            ...
            asn1Init_e2ap_RICrequestID(pvalue->
                value.u._e2ap_RICqueryResponse_IEs_id_RICrequestID);
            ...
            asn1Init_e2ap_RANfunctionID(pvalue->
                value.u._e2ap_RICqueryResponse_IEs_id_RANfunctionID);
            ...
            asn1Init_e2ap_RICqueryOutcome(pvalue->
                value.u._e2ap_RICqueryResponse_IEs_id_RICqueryOutcome);
...
void asn1Free_e2ap_RICqueryResponse_protocolIEs_element(OSCTXT* pctxt, e2ap_RICqueryResponse_protocolIEs_element* pvalue)
{
    ...
    switch(pvalue->value.t){
        case T_E2AP_PDU_Contents_e2ap_RICqueryResponse_IEs_id_RICrequestID:
            // rtxFreeE2ap_RICrequestID(pvalue->value.u._e2ap_RICqueryResponse_IEs_id_RICrequestID);

            if(pvalue->value.i._e2ap_RICqueryResponse_IEs_id_RICrequestID!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICqueryResponse_IEs_id_RANfunctionID:
            // rtxFreeE2ap_RANfunctionID(pvalue->value.u._e2ap_RICqueryResponse_IEs_id_RANfunctionID);

            if(pvalue->value.i._e2ap_RICqueryResponse_IEs_id_RANfunctionID!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICqueryResponse_IEs_id_RICqueryOutcome:
            // rtxFreeE2ap_RICqueryOutcome(pvalue->value.u._e2ap_RICqueryResponse_IEs_id_RICqueryOutcome);

            if(pvalue->value.i._e2ap_RICqueryResponse_IEs_id_RICqueryOutcome!=NULL){
    ...
    RTXCTXTPUSHELEMNAME(pctxt, "value");
        ...
        switch(pvalue->value.t){
            case T_E2AP_PDU_Contents_e2ap_RICqueryResponse_IEs_id_RICrequestID:
            {
                ...
                stat = asn1PrtToStr_e2ap_RICrequestID (pctxt, pvalue->value.u._e2ap_RICqueryResponse_IEs_id_RICrequestID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICqueryResponse_IEs_id_RANfunctionID:
            {
                ...
                stat = asn1PrtToStr_e2ap_RANfunctionID (pctxt, pvalue->value.u._e2ap_RICqueryResponse_IEs_id_RANfunctionID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICqueryResponse_IEs_id_RICqueryOutcome:
            {
                RTXCTXTPUSHELEMNAME (pctxt, "RICqueryOutcome");

                stat = asn1PrtToStr_e2ap_RICqueryOutcome (pctxt, pvalue->value.u._e2ap_RICqueryResponse_IEs_id_RICqueryOutcome);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
...
#endif
// --- End of e2ap_RICqueryResponse_protocolIEs_element.c ---
