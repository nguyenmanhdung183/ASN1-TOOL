...
/***********************************************************/
/* File .c missing: e2ap_RICserviceLoadStatusFailure_IEs.c */
/***********************************************************/

// --- Begin of e2ap_RICserviceLoadStatusFailure.c ---
...
// --- End of e2ap_RICserviceLoadStatusFailure.c ---

// --- Begin of e2ap_RICserviceLoadStatusFailure_protocolIEs.c ---
/******************************************************/
/*                                                    */
...
EXTERN int asn1PE_e2ap_RICserviceLoadStatusFailure_protocolIEs (OSCTXT* pctxt, e2ap_RICserviceLoadStatusFailure_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
...
// --- End of e2ap_RICserviceLoadStatusFailure_protocolIEs.c ---

// --- Begin of e2ap_RICserviceLoadStatusFailure_protocolIEs_element.c ---
/*****************************************/
/*    RICserviceLoadStatusFailure_protocolIEs_element     */
/*****************************************/
...
EXTERN int  asn1PD_e2ap_RICserviceLoadStatusFailure_protocolIEs_element (OSCTXT* pctxt, e2ap_RICserviceLoadStatusFailure_protocolIEs_element* pvalue){
...

    {
        ...
        switch(pvalue->id){//dungnm23 check case lai nhe
            ...
            pvalue->value.t = T_E2AP_PDU_Contents_e2ap_RICserviceLoadStatusFailure_IEs_id_LoadMeasurementID;
            RTXCTXTPUSHELEMNAME(pctxt, "id-RICloadMeasurementID");
            pvalue->value.u._e2ap_RICserviceLoadStatusFailure_IEs_id_LoadMeasurementID 
                = rtxMemAllocType(pctxt, e2ap_LoadMeasurementID);

            asn1Init_e2ap_LoadMeasurementID(pvalue->
                value.u._e2ap_RICserviceLoadStatusFailure_IEs_id_LoadMeasurementID);

            stat = asn1PD_e2ap_LoadMeasurementID (pctxt,
                (e2ap_LoadMeasurementID*)pvalue->value.
                u._e2ap_RICserviceLoadStatusFailure_IEs_id_LoadMeasurementID);
            if(stat!=0) return LOG_RTERR(pctxt, stat);
            RTXCTXTPOPELEMNAME(pctxt);
            break;
            ...
            asn1Init_e2ap_Cause(pvalue->
                value.u._e2ap_RICserviceLoadStatusFailure_IEs_id_Cause);
            ...
            asn1Init_e2ap_CriticalityDiagnostics(pvalue->
                value.u._e2ap_RICserviceLoadStatusFailure_IEs_id_CriticalityDiagnostics);
...
void asn1Free_e2ap_RICserviceLoadStatusFailure_protocolIEs_element(OSCTXT* pctxt, e2ap_RICserviceLoadStatusFailure_protocolIEs_element* pvalue)
{
    ...
    switch(pvalue->value.t){
        case T_E2AP_PDU_Contents_e2ap_RICserviceLoadStatusFailure_IEs_id_LoadMeasurementID:
            // rtxFreeE2ap_LoadMeasurementID(pvalue->value.u._e2ap_RICserviceLoadStatusFailure_IEs_id_LoadMeasurementID);

            if(pvalue->value.i._e2ap_RICserviceLoadStatusFailure_IEs_id_LoadMeasurementID!=NULL){
            asn1Free_e2ap_LoadMeasurementID(pctxt, pvalue->value.u._e2ap_RICserviceLoadStatusFailure_IEs_id_LoadMeasurementID);
            rtxMemFreePtr(pctxt, (void*)pvalue->value.u._e2ap_RICserviceLoadStatusFailure_IEs_id_LoadMeasurementID);
            pvalue->value.u._e2ap_RICserviceLoadStatusFailure_IEs_id_LoadMeasurementID = NULL;
            }
            break;
        case T_E2AP_PDU_Contents_e2ap_RICserviceLoadStatusFailure_IEs_id_LoadMeasurementID:
            // rtxFreeE2ap_LoadMeasurementID(pvalue->value.u._e2ap_RICserviceLoadStatusFailure_IEs_id_LoadMeasurementID);
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICserviceLoadStatusFailure_IEs_id_Cause:
            // rtxFreeE2ap_Cause(pvalue->value.u._e2ap_RICserviceLoadStatusFailure_IEs_id_Cause);

            if(pvalue->value.i._e2ap_RICserviceLoadStatusFailure_IEs_id_Cause!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICserviceLoadStatusFailure_IEs_id_CriticalityDiagnostics:
            // rtxFreeE2ap_CriticalityDiagnostics(pvalue->value.u._e2ap_RICserviceLoadStatusFailure_IEs_id_CriticalityDiagnostics);

            if(pvalue->value.i._e2ap_RICserviceLoadStatusFailure_IEs_id_CriticalityDiagnostics!=NULL){
    ...
    RTXCTXTPUSHELEMNAME(pctxt, "value");
        ...
        switch(pvalue->value.t){
            case T_E2AP_PDU_Contents_e2ap_RICserviceLoadStatusFailure_IEs_id_LoadMeasurementID:
            {
                ...
                stat = asn1PrtToStr_e2ap_LoadMeasurementID (pctxt, pvalue->value.u._e2ap_RICserviceLoadStatusFailure_IEs_id_LoadMeasurementID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICserviceLoadStatusFailure_IEs_id_Cause:
            {
                ...
                stat = asn1PrtToStr_e2ap_Cause (pctxt, pvalue->value.u._e2ap_RICserviceLoadStatusFailure_IEs_id_Cause);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICserviceLoadStatusFailure_IEs_id_CriticalityDiagnostics:
            {
                ...
                stat = asn1PrtToStr_e2ap_CriticalityDiagnostics (pctxt, pvalue->value.u._e2ap_RICserviceLoadStatusFailure_IEs_id_CriticalityDiagnostics);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
...
#endif
// --- End of e2ap_RICserviceLoadStatusFailure_protocolIEs_element.c ---
