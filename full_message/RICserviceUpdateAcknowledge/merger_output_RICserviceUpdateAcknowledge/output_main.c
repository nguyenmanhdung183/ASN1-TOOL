...
/* e2ap_RANfunctionIDcause_ItemIEs.c */
...
int asn1PE_e2ap_RANfunctionIDcause_ItemIEs (OSCTXT* pctxt, e2ap_RANfunctionIDcause_ItemIEs* pvalue)
{
   ...
   /* encode id */
   RTXCTXTPUSHELEMNAME (pctxt, "id");
   stat = asn1PE_e2ap_ProtocolIE_ID (pctxt, &pvalue->value.u_RANfunctionIDcause_ItemIEs_.id);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);

   /* encode criticality */
   RTXCTXTPUSHELEMNAME (pctxt, "criticality");
   stat = asn1PE_e2ap_Criticality (pctxt, &pvalue->value.u_RANfunctionIDcause_ItemIEs_.criticality);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);
...

   {
      ...
      switch (pvalue->value.t) {
      case T_E2AP_PDU_Contents_RANfunctionIDcause_ItemIEs_RANfunctionIDcause_Item:
         
         RTXCTXTPUSHELEMNAME (pctxt, "RANfunctionIDcause_Item");
...
/***********************************************************/
/* File .c missing: e2ap_RICserviceUpdateAcknowledge_IEs.c */
/***********************************************************/

// --- Begin of e2ap_RICserviceUpdateAcknowledge.c ---
...
// --- End of e2ap_RICserviceUpdateAcknowledge.c ---

// --- Begin of e2ap_RICserviceUpdateAcknowledge_protocolIEs.c ---
/******************************************************/
/*                                                    */
...
EXTERN int asn1PE_e2ap_RICserviceUpdateAcknowledge_protocolIEs (OSCTXT* pctxt, e2ap_RICserviceUpdateAcknowledge_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
...
// --- End of e2ap_RICserviceUpdateAcknowledge_protocolIEs.c ---

// --- Begin of e2ap_RICserviceUpdateAcknowledge_protocolIEs_element.c ---
/*****************************************/
...

    {
        ...
        switch(pvalue->id){//dungnm23 check case lai nhe
            ...
            asn1Init_e2ap_TransactionID(pvalue->
                value.u._e2ap_RICserviceUpdateAcknowledge_IEs_id_TransactionID);
            ...
            pvalue->value.t = T_E2AP_PDU_Contents_e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsID_List;
            RTXCTXTPUSHELEMNAME(pctxt, "id-RANfunctionsAccepted");
            pvalue->value.u._e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsID_List 
                = rtxMemAllocType(pctxt, e2ap_RANfunctionsID_List);

            asn1Init_e2ap_RANfunctionsID_List(pvalue->
                value.u._e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsID_List);

            stat = asn1PD_e2ap_RANfunctionsID_List (pctxt,
                (e2ap_RANfunctionsID_List*)pvalue->value.
                u._e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsID_List);
            if(stat!=0) return LOG_RTERR(pctxt, stat);
            RTXCTXTPOPELEMNAME(pctxt);
            break;
            ...
            pvalue->value.t = T_E2AP_PDU_Contents_e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsIDcause_List;
            RTXCTXTPUSHELEMNAME(pctxt, "id-RANfunctionsRejected");
            pvalue->value.u._e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsIDcause_List 
                = rtxMemAllocType(pctxt, e2ap_RANfunctionsIDcause_List);

            asn1Init_e2ap_RANfunctionsIDcause_List(pvalue->
                value.u._e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsIDcause_List);

            stat = asn1PD_e2ap_RANfunctionsIDcause_List (pctxt,
                (e2ap_RANfunctionsIDcause_List*)pvalue->value.
                u._e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsIDcause_List);
            if(stat!=0) return LOG_RTERR(pctxt, stat);
            RTXCTXTPOPELEMNAME(pctxt);
            break;
...
void asn1Free_e2ap_RICserviceUpdateAcknowledge_protocolIEs_element(OSCTXT* pctxt, e2ap_RICserviceUpdateAcknowledge_protocolIEs_element* pvalue)
{
    ...
    switch(pvalue->value.t){
        case T_E2AP_PDU_Contents_e2ap_RICserviceUpdateAcknowledge_IEs_id_TransactionID:
            // rtxFreeE2ap_TransactionID(pvalue->value.u._e2ap_RICserviceUpdateAcknowledge_IEs_id_TransactionID);

            if(pvalue->value.i._e2ap_RICserviceUpdateAcknowledge_IEs_id_TransactionID!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsID_List:
            // rtxFreeE2ap_RANfunctionsID_List(pvalue->value.u._e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsID_List);

            if(pvalue->value.i._e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsID_List!=NULL){
            asn1Free_e2ap_RANfunctionsID_List(pctxt, pvalue->value.u._e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsID_List);
            rtxMemFreePtr(pctxt, (void*)pvalue->value.u._e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsID_List);
            pvalue->value.u._e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsID_List = NULL;
            }
            break;
        case T_E2AP_PDU_Contents_e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsIDcause_List:
            // rtxFreeE2ap_RANfunctionsIDcause_List(pvalue->value.u._e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsIDcause_List);

            if(pvalue->value.i._e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsIDcause_List!=NULL){
            asn1Free_e2ap_RANfunctionsIDcause_List(pctxt, pvalue->value.u._e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsIDcause_List);
            rtxMemFreePtr(pctxt, (void*)pvalue->value.u._e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsIDcause_List);
            pvalue->value.u._e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsIDcause_List = NULL;
            }
            break;
        case T_E2AP_PDU_Contents_e2ap_RICserviceUpdateAcknowledge_IEs_UNDEF_:
    ...
    RTXCTXTPUSHELEMNAME(pctxt, "value");
        ...
        switch(pvalue->value.t){
            case T_E2AP_PDU_Contents_e2ap_RICserviceUpdateAcknowledge_IEs_id_TransactionID:
            {
                ...
                stat = asn1PrtToStr_e2ap_TransactionID (pctxt, pvalue->value.u._e2ap_RICserviceUpdateAcknowledge_IEs_id_TransactionID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsID_List:
            {
                ...
                stat = asn1PrtToStr_e2ap_RANfunctionsID_List (pctxt, pvalue->value.u._e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsID_List);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsIDcause_List:
            {
                ...
                stat = asn1PrtToStr_e2ap_RANfunctionsIDcause_List (pctxt, pvalue->value.u._e2ap_RICserviceUpdateAcknowledge_IEs_id_RANfunctionsIDcause_List);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
...
#endif
// --- End of e2ap_RICserviceUpdateAcknowledge_protocolIEs_element.c ---
