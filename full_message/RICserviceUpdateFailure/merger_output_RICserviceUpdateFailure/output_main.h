...
/*******************************************************/
/* File .h missing: e2ap_RICserviceUpdateFailure_IEs.h */
/*******************************************************/

// --- Begin of e2ap_RICserviceUpdateFailure.h ---
/*****************************************/
...
// --- End of e2ap_RICserviceUpdateFailure.h ---

// --- Begin of e2ap_RICserviceUpdateFailure_protocolIEs.h ---
/******************************************************/
/*                                                    */
...
/*type was extract from RICserviceUpdateFailure*/
...
// --- End of e2ap_RICserviceUpdateFailure_protocolIEs.h ---

// --- Begin of e2ap_RICserviceUpdateFailure_protocolIEs_element.h ---
/*****************************************/
...
typedef struct EXTERN e2ap_RICserviceUpdateFailure_protocolIEs_element {
   ...
   struct{
      ...
      union {
        ...
        *presence: MANDATORY
        */
        e2ap_TransactionID *_e2ap_RICserviceUpdateFailure_IEs_id_TransactionID;
        ...
        *presence: MANDATORY
        */
        e2ap_Cause *_e2ap_RICserviceUpdateFailure_IEs_id_Cause;
        ...
        *presence: OPTIONAL
        */
        e2ap_TimeToWait *_e2ap_RICserviceUpdateFailure_IEs_id_TimeToWait;
        ...
        *presence: OPTIONAL
        */
        e2ap_CriticalityDiagnostics *_e2ap_RICserviceUpdateFailure_IEs_id_CriticalityDiagnostics;
...
// --- End of e2ap_RICserviceUpdateFailure_protocolIEs_element.h ---
