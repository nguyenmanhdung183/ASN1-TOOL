...
// --- Begin of e2ap_RICaction_Admitted_Item.c ---
...
// --- End of e2ap_RICaction_Admitted_Item.c ---

// --- Begin of e2ap_RICaction_Admitted_ItemIEs.c ---
/* e2ap_RICaction_Admitted_ItemIEs.c */
...
int asn1PE_e2ap_RICaction_Admitted_ItemIEs (OSCTXT* pctxt, e2ap_RICaction_Admitted_ItemIEs* pvalue)
{
   ...
   stat = asn1PE_e2ap_ProtocolIE_ID (pctxt, &pvalue->value.u_RICaction_Admitted_ItemIEs_.id);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);

   /* encode criticality */
   RTXCTXTPUSHELEMNAME (pctxt, "criticality");
   stat = asn1PE_e2ap_Criticality (pctxt, &pvalue->value.u_RICaction_Admitted_ItemIEs_.criticality);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);
...

   {
      ...
      case T_E2AP_PDU_Contents_RICaction_Admitted_ItemIEs_RICaction_Admitted_Item:
         
         RTXCTXTPUSHELEMNAME (pctxt, "RICaction_Admitted_Item");
         stat = asn1PE_e2ap_RICaction_Admitted_Item (pctxt, pvalue->value.u._e2apRICaction_Admitted_ItemIEs_RICaction_Admitted_Item);
         RTXCTXTPOPELEMNAME (pctxt);
...
// --- End of e2ap_RICaction_Admitted_ItemIEs.c ---

// --- Begin of e2ap_RICaction_Admitted_List.c ---
/*****************************************/
...
#endif
// --- End of e2ap_RICaction_Admitted_List.c ---

// --- Begin of e2ap_RICsubscriptionAuditAction_Item.c ---
...
int asn1PE_e2ap_RICsubscriptionAuditAction_Item (OSCTXT* pctxt, e2ap_RICsubscriptionAuditAction_Item* pvalue)
{
   ...
   /* encode field ricAction_Admitted_List */  
...
// --- End of e2ap_RICsubscriptionAuditAction_Item.c ---

// --- Begin of e2ap_RICsubscriptionAuditAction_ItemIEs.c ---
/* e2ap_RICsubscriptionAuditAction_ItemIEs.c */
...
int asn1PE_e2ap_RICsubscriptionAuditAction_ItemIEs (OSCTXT* pctxt, e2ap_RICsubscriptionAuditAction_ItemIEs* pvalue)
{
   ...
   /* encode id */
   RTXCTXTPUSHELEMNAME (pctxt, "id");
   stat = asn1PE_e2ap_ProtocolIE_ID (pctxt, &pvalue->value.u_RICsubscriptionAuditAction_ItemIEs_.id);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);

   /* encode criticality */
   RTXCTXTPUSHELEMNAME (pctxt, "criticality");
   stat = asn1PE_e2ap_Criticality (pctxt, &pvalue->value.u_RICsubscriptionAuditAction_ItemIEs_.criticality);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);
...

   {
      ...
      switch (pvalue->value.t) {
      case T_E2AP_PDU_Contents_RICsubscriptionAuditAction_ItemIEs_RICsubscriptionAuditAction_Item:
         
         RTXCTXTPUSHELEMNAME (pctxt, "RICsubscriptionAuditAction_Item");
         stat = asn1PE_e2ap_RICsubscriptionAuditAction_Item (pctxt, pvalue->value.u._e2apRICsubscriptionAuditAction_ItemIEs_RICsubscriptionAuditAction_Item);
         RTXCTXTPOPELEMNAME (pctxt);
...
// --- End of e2ap_RICsubscriptionAuditAction_ItemIEs.c ---

// --- Begin of e2ap_RICsubscriptionAuditActionList.c ---
/*****************************************/
...
int asn1PE_e2ap_RICsubscriptionAuditActionList (OSCTXT* pctxt, e2ap_RICsubscriptionAuditActionList* pvalue)
{
   ...
   /* encode length determinant */
   PU_SETSIZECONSTRAINT (pctxt, OSUINTCONST(1), OSUINTCONST(ASN1V_e2ap_maxofRICsubscriptions), 0, 0);
...
#endif
// --- End of e2ap_RICsubscriptionAuditActionList.c ---

// --- Begin of e2ap_RICsubscriptionAudit_Item.c ---
...
// --- End of e2ap_RICsubscriptionAudit_Item.c ---

// --- Begin of e2ap_RICsubscriptionAudit_ItemIEs.c ---
/* e2ap_RICsubscriptionAudit_ItemIEs.c */
...
int asn1PE_e2ap_RICsubscriptionAudit_ItemIEs (OSCTXT* pctxt, e2ap_RICsubscriptionAudit_ItemIEs* pvalue)
{
   ...
   /* encode id */
   RTXCTXTPUSHELEMNAME (pctxt, "id");
   stat = asn1PE_e2ap_ProtocolIE_ID (pctxt, &pvalue->value.u_RICsubscriptionAudit_ItemIEs_.id);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);

   /* encode criticality */
   RTXCTXTPUSHELEMNAME (pctxt, "criticality");
   stat = asn1PE_e2ap_Criticality (pctxt, &pvalue->value.u_RICsubscriptionAudit_ItemIEs_.criticality);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);
...

   {
      ...
      switch (pvalue->value.t) {
      case T_E2AP_PDU_Contents_RICsubscriptionAudit_ItemIEs_RICsubscriptionAudit_Item:
         
         RTXCTXTPUSHELEMNAME (pctxt, "RICsubscriptionAudit_Item");
         stat = asn1PE_e2ap_RICsubscriptionAudit_Item (pctxt, pvalue->value.u._e2apRICsubscriptionAudit_ItemIEs_RICsubscriptionAudit_Item);
         RTXCTXTPOPELEMNAME (pctxt);
...
// --- End of e2ap_RICsubscriptionAudit_ItemIEs.c ---

// --- Begin of e2ap_RICsubscriptionAuditList.c ---
/*****************************************/
...
#endif
// --- End of e2ap_RICsubscriptionAuditList.c ---

/************************************************************/
/* File .c missing: e2ap_RICsubscriptionAuditResponse_IEs.c */
/************************************************************/

// --- Begin of e2ap_RICsubscriptionAuditResponse.c ---
...
// --- End of e2ap_RICsubscriptionAuditResponse.c ---

// --- Begin of e2ap_RICsubscriptionAuditResponse_protocolIEs.c ---
/******************************************************/
/*                                                    */
...
EXTERN int asn1PE_e2ap_RICsubscriptionAuditResponse_protocolIEs (OSCTXT* pctxt, e2ap_RICsubscriptionAuditResponse_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
...
// --- End of e2ap_RICsubscriptionAuditResponse_protocolIEs.c ---

// --- Begin of e2ap_RICsubscriptionAuditResponse_protocolIEs_element.c ---
/*****************************************/
...

    {
        ...
        switch(pvalue->id){//dungnm23 check case lai nhe
            ...
            asn1Init_e2ap_RICrequestID(pvalue->
                value.u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICrequestID);
            ...
            pvalue->value.t = T_E2AP_PDU_Contents_e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditActionList;
            RTXCTXTPUSHELEMNAME(pctxt, "id-RICsubscriptionAuditConfirmedList");
            pvalue->value.u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditActionList 
                = rtxMemAllocType(pctxt, e2ap_RICsubscriptionAuditActionList);

            asn1Init_e2ap_RICsubscriptionAuditActionList(pvalue->
                value.u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditActionList);

            stat = asn1PD_e2ap_RICsubscriptionAuditActionList (pctxt,
                (e2ap_RICsubscriptionAuditActionList*)pvalue->value.
                u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditActionList);
            if(stat!=0) return LOG_RTERR(pctxt, stat);
            RTXCTXTPOPELEMNAME(pctxt);
            break;
            ...
            pvalue->value.t = T_E2AP_PDU_Contents_e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditList;
            RTXCTXTPUSHELEMNAME(pctxt, "id-RICsubscriptionAuditUnkownList");
            pvalue->value.u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditList 
                = rtxMemAllocType(pctxt, e2ap_RICsubscriptionAuditList);

            asn1Init_e2ap_RICsubscriptionAuditList(pvalue->
                value.u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditList);

            stat = asn1PD_e2ap_RICsubscriptionAuditList (pctxt,
                (e2ap_RICsubscriptionAuditList*)pvalue->value.
                u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditList);
            if(stat!=0) return LOG_RTERR(pctxt, stat);
            RTXCTXTPOPELEMNAME(pctxt);
            break;
...
void asn1Free_e2ap_RICsubscriptionAuditResponse_protocolIEs_element(OSCTXT* pctxt, e2ap_RICsubscriptionAuditResponse_protocolIEs_element* pvalue)
{
    ...
    switch(pvalue->value.t){
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionAuditResponse_IEs_id_RICrequestID:
            // rtxFreeE2ap_RICrequestID(pvalue->value.u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICrequestID);

            if(pvalue->value.i._e2ap_RICsubscriptionAuditResponse_IEs_id_RICrequestID!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditActionList:
            // rtxFreeE2ap_RICsubscriptionAuditActionList(pvalue->value.u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditActionList);

            if(pvalue->value.i._e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditActionList!=NULL){
            asn1Free_e2ap_RICsubscriptionAuditActionList(pctxt, pvalue->value.u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditActionList);
            rtxMemFreePtr(pctxt, (void*)pvalue->value.u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditActionList);
            pvalue->value.u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditActionList = NULL;
            }
            break;
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditList:
            // rtxFreeE2ap_RICsubscriptionAuditList(pvalue->value.u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditList);

            if(pvalue->value.i._e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditList!=NULL){
            asn1Free_e2ap_RICsubscriptionAuditList(pctxt, pvalue->value.u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditList);
            rtxMemFreePtr(pctxt, (void*)pvalue->value.u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditList);
            pvalue->value.u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditList = NULL;
            }
            break;
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditActionList:
            // rtxFreeE2ap_RICsubscriptionAuditActionList(pvalue->value.u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditActionList);
    ...
    RTXCTXTPUSHELEMNAME(pctxt, "value");
        ...
        switch(pvalue->value.t){
            case T_E2AP_PDU_Contents_e2ap_RICsubscriptionAuditResponse_IEs_id_RICrequestID:
            {
                ...
                stat = asn1PrtToStr_e2ap_RICrequestID (pctxt, pvalue->value.u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICrequestID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditActionList:
            {
                RTXCTXTPUSHELEMNAME (pctxt, "RICsubscriptionAuditActionList");

                stat = asn1PrtToStr_e2ap_RICsubscriptionAuditActionList (pctxt, pvalue->value.u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditActionList);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditList:
            {
                RTXCTXTPUSHELEMNAME (pctxt, "RICsubscriptionAuditList");

                stat = asn1PrtToStr_e2ap_RICsubscriptionAuditList (pctxt, pvalue->value.u._e2ap_RICsubscriptionAuditResponse_IEs_id_RICsubscriptionAuditList);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
...
#endif
// --- End of e2ap_RICsubscriptionAuditResponse_protocolIEs_element.c ---
