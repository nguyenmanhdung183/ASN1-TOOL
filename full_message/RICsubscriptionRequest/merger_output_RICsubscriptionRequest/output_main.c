...
// --- Begin of e2ap_RICaction_ToBeSetup_Item.c ---
...
// --- End of e2ap_RICaction_ToBeSetup_Item.c ---

// --- Begin of e2ap_RICaction_ToBeSetup_ItemIEs.c ---
/* e2ap_RICaction_ToBeSetup_ItemIEs.c */
...
int asn1PE_e2ap_RICaction_ToBeSetup_ItemIEs (OSCTXT* pctxt, e2ap_RICaction_ToBeSetup_ItemIEs* pvalue)
{
   ...
   stat = asn1PE_e2ap_ProtocolIE_ID (pctxt, &pvalue->value.u_RICaction_ToBeSetup_ItemIEs_.id);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);

   /* encode criticality */
   RTXCTXTPUSHELEMNAME (pctxt, "criticality");
   stat = asn1PE_e2ap_Criticality (pctxt, &pvalue->value.u_RICaction_ToBeSetup_ItemIEs_.criticality);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);
...

   {
      ...
      case T_E2AP_PDU_Contents_RICaction_ToBeSetup_ItemIEs_RICaction_ToBeSetup_Item:
         
         RTXCTXTPUSHELEMNAME (pctxt, "RICaction_ToBeSetup_Item");
         stat = asn1PE_e2ap_RICaction_ToBeSetup_Item (pctxt, pvalue->value.u._e2apRICaction_ToBeSetup_ItemIEs_RICaction_ToBeSetup_Item);
         RTXCTXTPOPELEMNAME (pctxt);
...
// --- End of e2ap_RICaction_ToBeSetup_ItemIEs.c ---

// --- Begin of e2ap_RICactions_ToBeSetup_List.c ---
/*****************************************/
...
#endif
// --- End of e2ap_RICactions_ToBeSetup_List.c ---

// --- Begin of e2ap_RICsubscriptionDetails.c ---
...
int asn1PE_e2ap_RICsubscriptionDetails (OSCTXT* pctxt, e2ap_RICsubscriptionDetails* pvalue)
{
   ...
   /* encode field ricEventTriggerDefinition */  
   ...
   /* encode field ricAction_ToBeSetup_List */  
...
// --- End of e2ap_RICsubscriptionDetails.c ---

// --- Begin of e2ap_RICsubscriptionTime.c ---
/*****************************************/
/*           RICsubscriptionTime                */
/*****************************************/
//octet string
...
// --- End of e2ap_RICsubscriptionTime.c ---

/******************************************************/
/* File .c missing: e2ap_RICsubscriptionRequest_IEs.c */
/******************************************************/

// --- Begin of e2ap_RICsubscriptionRequest.c ---
...
// --- End of e2ap_RICsubscriptionRequest.c ---

// --- Begin of e2ap_RICsubscriptionRequest_protocolIEs.c ---
/******************************************************/
/*                                                    */
...
EXTERN int asn1PE_e2ap_RICsubscriptionRequest_protocolIEs (OSCTXT* pctxt, e2ap_RICsubscriptionRequest_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
...
// --- End of e2ap_RICsubscriptionRequest_protocolIEs.c ---

// --- Begin of e2ap_RICsubscriptionRequest_protocolIEs_element.c ---
/*****************************************/
...

    {
        ...
        switch(pvalue->id){//dungnm23 check case lai nhe
            ...
            asn1Init_e2ap_RICrequestID(pvalue->
                value.u._e2ap_RICsubscriptionRequest_IEs_id_RICrequestID);
            ...
            asn1Init_e2ap_RANfunctionID(pvalue->
                value.u._e2ap_RICsubscriptionRequest_IEs_id_RANfunctionID);
            ...
            asn1Init_e2ap_RICsubscriptionDetails(pvalue->
                value.u._e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionDetails);
            ...
            pvalue->value.t = T_E2AP_PDU_Contents_e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionTime;
            RTXCTXTPUSHELEMNAME(pctxt, "id-RICsubscriptionStartTime");
            pvalue->value.u._e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionTime 
                = rtxMemAllocType(pctxt, e2ap_RICsubscriptionTime);

            asn1Init_e2ap_RICsubscriptionTime(pvalue->
                value.u._e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionTime);

            stat = asn1PD_e2ap_RICsubscriptionTime (pctxt,
                (e2ap_RICsubscriptionTime*)pvalue->value.
                u._e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionTime);
            if(stat!=0) return LOG_RTERR(pctxt, stat);
            RTXCTXTPOPELEMNAME(pctxt);
            break;
...
void asn1Free_e2ap_RICsubscriptionRequest_protocolIEs_element(OSCTXT* pctxt, e2ap_RICsubscriptionRequest_protocolIEs_element* pvalue)
{
    ...
    switch(pvalue->value.t){
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionRequest_IEs_id_RICrequestID:
            // rtxFreeE2ap_RICrequestID(pvalue->value.u._e2ap_RICsubscriptionRequest_IEs_id_RICrequestID);

            if(pvalue->value.i._e2ap_RICsubscriptionRequest_IEs_id_RICrequestID!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionRequest_IEs_id_RANfunctionID:
            // rtxFreeE2ap_RANfunctionID(pvalue->value.u._e2ap_RICsubscriptionRequest_IEs_id_RANfunctionID);

            if(pvalue->value.i._e2ap_RICsubscriptionRequest_IEs_id_RANfunctionID!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionDetails:
            // rtxFreeE2ap_RICsubscriptionDetails(pvalue->value.u._e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionDetails);

            if(pvalue->value.i._e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionDetails!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionTime:
            // rtxFreeE2ap_RICsubscriptionTime(pvalue->value.u._e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionTime);

            if(pvalue->value.i._e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionTime!=NULL){
            asn1Free_e2ap_RICsubscriptionTime(pctxt, pvalue->value.u._e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionTime);
            rtxMemFreePtr(pctxt, (void*)pvalue->value.u._e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionTime);
            pvalue->value.u._e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionTime = NULL;
            }
            break;
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionTime:
            // rtxFreeE2ap_RICsubscriptionTime(pvalue->value.u._e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionTime);
    ...
    RTXCTXTPUSHELEMNAME(pctxt, "value");
        ...
        switch(pvalue->value.t){
            case T_E2AP_PDU_Contents_e2ap_RICsubscriptionRequest_IEs_id_RICrequestID:
            {
                ...
                stat = asn1PrtToStr_e2ap_RICrequestID (pctxt, pvalue->value.u._e2ap_RICsubscriptionRequest_IEs_id_RICrequestID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICsubscriptionRequest_IEs_id_RANfunctionID:
            {
                ...
                stat = asn1PrtToStr_e2ap_RANfunctionID (pctxt, pvalue->value.u._e2ap_RICsubscriptionRequest_IEs_id_RANfunctionID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionDetails:
            {
                RTXCTXTPUSHELEMNAME (pctxt, "RICsubscriptionDetails");

                stat = asn1PrtToStr_e2ap_RICsubscriptionDetails (pctxt, pvalue->value.u._e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionDetails);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionTime:
            {
                RTXCTXTPUSHELEMNAME (pctxt, "RICsubscriptionTime");

                stat = asn1PrtToStr_e2ap_RICsubscriptionTime (pctxt, pvalue->value.u._e2ap_RICsubscriptionRequest_IEs_id_RICsubscriptionTime);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
...
#endif
// --- End of e2ap_RICsubscriptionRequest_protocolIEs_element.c ---
