...
// --- Begin of e2ap_RICaction_NotAdmitted_Item.c ---
...
// --- End of e2ap_RICaction_NotAdmitted_Item.c ---

// --- Begin of e2ap_RICaction_NotAdmitted_ItemIEs.c ---
/* e2ap_RICaction_NotAdmitted_ItemIEs.c */
...
int asn1PE_e2ap_RICaction_NotAdmitted_ItemIEs (OSCTXT* pctxt, e2ap_RICaction_NotAdmitted_ItemIEs* pvalue)
{
   ...
   /* encode id */
   RTXCTXTPUSHELEMNAME (pctxt, "id");
   stat = asn1PE_e2ap_ProtocolIE_ID (pctxt, &pvalue->value.u_RICaction_NotAdmitted_ItemIEs_.id);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);

   /* encode criticality */
   RTXCTXTPUSHELEMNAME (pctxt, "criticality");
   stat = asn1PE_e2ap_Criticality (pctxt, &pvalue->value.u_RICaction_NotAdmitted_ItemIEs_.criticality);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);
...

   {
      ...
      switch (pvalue->value.t) {
      case T_E2AP_PDU_Contents_RICaction_NotAdmitted_ItemIEs_RICaction_NotAdmitted_Item:
         
         RTXCTXTPUSHELEMNAME (pctxt, "RICaction_NotAdmitted_Item");
         stat = asn1PE_e2ap_RICaction_NotAdmitted_Item (pctxt, pvalue->value.u._e2apRICaction_NotAdmitted_ItemIEs_RICaction_NotAdmitted_Item);
         RTXCTXTPOPELEMNAME (pctxt);
...
// --- End of e2ap_RICaction_NotAdmitted_ItemIEs.c ---

// --- Begin of e2ap_RICaction_NotAdmitted_List.c ---
/*****************************************/
...
#endif
// --- End of e2ap_RICaction_NotAdmitted_List.c ---

/*******************************************************/
/* File .c missing: e2ap_RICsubscriptionResponse_IEs.c */
/*******************************************************/

// --- Begin of e2ap_RICsubscriptionResponse.c ---
...
// --- End of e2ap_RICsubscriptionResponse.c ---

// --- Begin of e2ap_RICsubscriptionResponse_protocolIEs.c ---
/******************************************************/
/*                                                    */
...
EXTERN int asn1PE_e2ap_RICsubscriptionResponse_protocolIEs (OSCTXT* pctxt, e2ap_RICsubscriptionResponse_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
...
// --- End of e2ap_RICsubscriptionResponse_protocolIEs.c ---

// --- Begin of e2ap_RICsubscriptionResponse_protocolIEs_element.c ---
/*****************************************/
...

    {
        ...
        switch(pvalue->id){//dungnm23 check case lai nhe
            ...
            asn1Init_e2ap_RICrequestID(pvalue->
                value.u._e2ap_RICsubscriptionResponse_IEs_id_RICrequestID);
            ...
            asn1Init_e2ap_RANfunctionID(pvalue->
                value.u._e2ap_RICsubscriptionResponse_IEs_id_RANfunctionID);
            ...
            pvalue->value.t = T_E2AP_PDU_Contents_e2ap_RICsubscriptionResponse_IEs_id_RICaction_Admitted_List;
            RTXCTXTPUSHELEMNAME(pctxt, "id-RICactions-Admitted");
            pvalue->value.u._e2ap_RICsubscriptionResponse_IEs_id_RICaction_Admitted_List 
                = rtxMemAllocType(pctxt, e2ap_RICaction_Admitted_List);

            asn1Init_e2ap_RICaction_Admitted_List(pvalue->
                value.u._e2ap_RICsubscriptionResponse_IEs_id_RICaction_Admitted_List);

            stat = asn1PD_e2ap_RICaction_Admitted_List (pctxt,
                (e2ap_RICaction_Admitted_List*)pvalue->value.
                u._e2ap_RICsubscriptionResponse_IEs_id_RICaction_Admitted_List);
            if(stat!=0) return LOG_RTERR(pctxt, stat);
            RTXCTXTPOPELEMNAME(pctxt);
            break;
            ...
            pvalue->value.t = T_E2AP_PDU_Contents_e2ap_RICsubscriptionResponse_IEs_id_RICaction_NotAdmitted_List;
            RTXCTXTPUSHELEMNAME(pctxt, "id-RICactions-NotAdmitted");
            pvalue->value.u._e2ap_RICsubscriptionResponse_IEs_id_RICaction_NotAdmitted_List 
                = rtxMemAllocType(pctxt, e2ap_RICaction_NotAdmitted_List);

            asn1Init_e2ap_RICaction_NotAdmitted_List(pvalue->
                value.u._e2ap_RICsubscriptionResponse_IEs_id_RICaction_NotAdmitted_List);

            stat = asn1PD_e2ap_RICaction_NotAdmitted_List (pctxt,
                (e2ap_RICaction_NotAdmitted_List*)pvalue->value.
                u._e2ap_RICsubscriptionResponse_IEs_id_RICaction_NotAdmitted_List);
            if(stat!=0) return LOG_RTERR(pctxt, stat);
            RTXCTXTPOPELEMNAME(pctxt);
            break;
...
void asn1Free_e2ap_RICsubscriptionResponse_protocolIEs_element(OSCTXT* pctxt, e2ap_RICsubscriptionResponse_protocolIEs_element* pvalue)
{
    ...
    switch(pvalue->value.t){
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionResponse_IEs_id_RICrequestID:
            // rtxFreeE2ap_RICrequestID(pvalue->value.u._e2ap_RICsubscriptionResponse_IEs_id_RICrequestID);

            if(pvalue->value.i._e2ap_RICsubscriptionResponse_IEs_id_RICrequestID!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionResponse_IEs_id_RANfunctionID:
            // rtxFreeE2ap_RANfunctionID(pvalue->value.u._e2ap_RICsubscriptionResponse_IEs_id_RANfunctionID);

            if(pvalue->value.i._e2ap_RICsubscriptionResponse_IEs_id_RANfunctionID!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionResponse_IEs_id_RICaction_Admitted_List:
            // rtxFreeE2ap_RICaction_Admitted_List(pvalue->value.u._e2ap_RICsubscriptionResponse_IEs_id_RICaction_Admitted_List);

            if(pvalue->value.i._e2ap_RICsubscriptionResponse_IEs_id_RICaction_Admitted_List!=NULL){
            asn1Free_e2ap_RICaction_Admitted_List(pctxt, pvalue->value.u._e2ap_RICsubscriptionResponse_IEs_id_RICaction_Admitted_List);
            rtxMemFreePtr(pctxt, (void*)pvalue->value.u._e2ap_RICsubscriptionResponse_IEs_id_RICaction_Admitted_List);
            pvalue->value.u._e2ap_RICsubscriptionResponse_IEs_id_RICaction_Admitted_List = NULL;
            }
            break;
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionResponse_IEs_id_RICaction_NotAdmitted_List:
            // rtxFreeE2ap_RICaction_NotAdmitted_List(pvalue->value.u._e2ap_RICsubscriptionResponse_IEs_id_RICaction_NotAdmitted_List);

            if(pvalue->value.i._e2ap_RICsubscriptionResponse_IEs_id_RICaction_NotAdmitted_List!=NULL){
            asn1Free_e2ap_RICaction_NotAdmitted_List(pctxt, pvalue->value.u._e2ap_RICsubscriptionResponse_IEs_id_RICaction_NotAdmitted_List);
            rtxMemFreePtr(pctxt, (void*)pvalue->value.u._e2ap_RICsubscriptionResponse_IEs_id_RICaction_NotAdmitted_List);
            pvalue->value.u._e2ap_RICsubscriptionResponse_IEs_id_RICaction_NotAdmitted_List = NULL;
            }
            break;
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionResponse_IEs_UNDEF_:
    ...
    RTXCTXTPUSHELEMNAME(pctxt, "value");
        ...
        switch(pvalue->value.t){
            case T_E2AP_PDU_Contents_e2ap_RICsubscriptionResponse_IEs_id_RICrequestID:
            {
                ...
                stat = asn1PrtToStr_e2ap_RICrequestID (pctxt, pvalue->value.u._e2ap_RICsubscriptionResponse_IEs_id_RICrequestID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICsubscriptionResponse_IEs_id_RANfunctionID:
            {
                ...
                stat = asn1PrtToStr_e2ap_RANfunctionID (pctxt, pvalue->value.u._e2ap_RICsubscriptionResponse_IEs_id_RANfunctionID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICsubscriptionResponse_IEs_id_RICaction_Admitted_List:
            {
                ...
                stat = asn1PrtToStr_e2ap_RICaction_Admitted_List (pctxt, pvalue->value.u._e2ap_RICsubscriptionResponse_IEs_id_RICaction_Admitted_List);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICsubscriptionResponse_IEs_id_RICaction_NotAdmitted_List:
            {
                RTXCTXTPUSHELEMNAME (pctxt, "RICaction-NotAdmitted-List");

                stat = asn1PrtToStr_e2ap_RICaction_NotAdmitted_List (pctxt, pvalue->value.u._e2ap_RICsubscriptionResponse_IEs_id_RICaction_NotAdmitted_List);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
...
#endif
// --- End of e2ap_RICsubscriptionResponse_protocolIEs_element.c ---
