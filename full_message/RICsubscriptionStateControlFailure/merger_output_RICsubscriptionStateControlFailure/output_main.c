...
/******************************************************************/
/* File .c missing: e2ap_RICsubscriptionStateControlFailure_IEs.c */
/******************************************************************/

// --- Begin of e2ap_RICsubscriptionStateControlFailure.c ---
...
// --- End of e2ap_RICsubscriptionStateControlFailure.c ---

// --- Begin of e2ap_RICsubscriptionStateControlFailure_protocolIEs.c ---
/******************************************************/
/*                                                    */
...
EXTERN int asn1PE_e2ap_RICsubscriptionStateControlFailure_protocolIEs (OSCTXT* pctxt, e2ap_RICsubscriptionStateControlFailure_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
...
// --- End of e2ap_RICsubscriptionStateControlFailure_protocolIEs.c ---

// --- Begin of e2ap_RICsubscriptionStateControlFailure_protocolIEs_element.c ---
/*****************************************/
/*    RICsubscriptionStateControlFailure_protocolIEs_element     */
/*****************************************/
...

    {
        ...
        switch(pvalue->id){//dungnm23 check case lai nhe
            ...
            asn1Init_e2ap_RICrequestID(pvalue->
                value.u._e2ap_RICsubscriptionStateControlFailure_IEs_id_RICrequestID);
            ...
            asn1Init_e2ap_Cause(pvalue->
                value.u._e2ap_RICsubscriptionStateControlFailure_IEs_id_Cause);
            ...
            asn1Init_e2ap_CriticalityDiagnostics(pvalue->
                value.u._e2ap_RICsubscriptionStateControlFailure_IEs_id_CriticalityDiagnostics);
...
void asn1Free_e2ap_RICsubscriptionStateControlFailure_protocolIEs_element(OSCTXT* pctxt, e2ap_RICsubscriptionStateControlFailure_protocolIEs_element* pvalue)
{
    ...
    switch(pvalue->value.t){
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionStateControlFailure_IEs_id_RICrequestID:
            // rtxFreeE2ap_RICrequestID(pvalue->value.u._e2ap_RICsubscriptionStateControlFailure_IEs_id_RICrequestID);

            if(pvalue->value.i._e2ap_RICsubscriptionStateControlFailure_IEs_id_RICrequestID!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionStateControlFailure_IEs_id_Cause:
            // rtxFreeE2ap_Cause(pvalue->value.u._e2ap_RICsubscriptionStateControlFailure_IEs_id_Cause);

            if(pvalue->value.i._e2ap_RICsubscriptionStateControlFailure_IEs_id_Cause!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionStateControlFailure_IEs_id_CriticalityDiagnostics:
            // rtxFreeE2ap_CriticalityDiagnostics(pvalue->value.u._e2ap_RICsubscriptionStateControlFailure_IEs_id_CriticalityDiagnostics);

            if(pvalue->value.i._e2ap_RICsubscriptionStateControlFailure_IEs_id_CriticalityDiagnostics!=NULL){
    ...
    RTXCTXTPUSHELEMNAME(pctxt, "value");
        ...
        switch(pvalue->value.t){
            case T_E2AP_PDU_Contents_e2ap_RICsubscriptionStateControlFailure_IEs_id_RICrequestID:
            {
                ...
                stat = asn1PrtToStr_e2ap_RICrequestID (pctxt, pvalue->value.u._e2ap_RICsubscriptionStateControlFailure_IEs_id_RICrequestID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICsubscriptionStateControlFailure_IEs_id_Cause:
            {
                ...
                stat = asn1PrtToStr_e2ap_Cause (pctxt, pvalue->value.u._e2ap_RICsubscriptionStateControlFailure_IEs_id_Cause);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICsubscriptionStateControlFailure_IEs_id_CriticalityDiagnostics:
            {
                ...
                stat = asn1PrtToStr_e2ap_CriticalityDiagnostics (pctxt, pvalue->value.u._e2ap_RICsubscriptionStateControlFailure_IEs_id_CriticalityDiagnostics);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
...
#endif
// --- End of e2ap_RICsubscriptionStateControlFailure_protocolIEs_element.c ---
