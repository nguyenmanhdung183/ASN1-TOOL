...
// --- Begin of e2ap_RICsubscriptionToBeSuspended_List.c ---
/*****************************************/
...
#endif
// --- End of e2ap_RICsubscriptionToBeSuspended_List.c ---

// --- Begin of e2ap_RICsubscriptionToBeResumed_List.c ---
/*****************************************/
...
#endif
// --- End of e2ap_RICsubscriptionToBeResumed_List.c ---

// --- Begin of e2ap_RANfunctionStateControl_Item.c ---
...
int asn1PE_e2ap_RANfunctionStateControl_Item (OSCTXT* pctxt, e2ap_RANfunctionStateControl_Item* pvalue)
{
   ...
   /* encode field ricSubscriptionToBeSuspended_list */  
   if (pvalue->m_ricSubscriptionToBeSuspended_listPresent) {
   ...
   /* encode field ricSubscriptionToBeResumed_list */  
   if (pvalue->m_ricSubscriptionToBeResumed_listPresent) {
...
// --- End of e2ap_RANfunctionStateControl_Item.c ---

// --- Begin of e2ap_RANfunctionStateControl_ItemIEs.c ---
/* e2ap_RANfunctionStateControl_ItemIEs.c */
...
int asn1PE_e2ap_RANfunctionStateControl_ItemIEs (OSCTXT* pctxt, e2ap_RANfunctionStateControl_ItemIEs* pvalue)
{
   ...
   /* encode id */
   RTXCTXTPUSHELEMNAME (pctxt, "id");
   stat = asn1PE_e2ap_ProtocolIE_ID (pctxt, &pvalue->value.u_RANfunctionStateControl_ItemIEs_.id);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);

   /* encode criticality */
   RTXCTXTPUSHELEMNAME (pctxt, "criticality");
   stat = asn1PE_e2ap_Criticality (pctxt, &pvalue->value.u_RANfunctionStateControl_ItemIEs_.criticality);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);
...

   {
      ...
      switch (pvalue->value.t) {
      case T_E2AP_PDU_Contents_RANfunctionStateControl_ItemIEs_RANfunctionStateControl_Item:
         
         RTXCTXTPUSHELEMNAME (pctxt, "RANfunctionStateControl_Item");
         stat = asn1PE_e2ap_RANfunctionStateControl_Item (pctxt, pvalue->value.u._e2apRANfunctionStateControl_ItemIEs_RANfunctionStateControl_Item);
         RTXCTXTPOPELEMNAME (pctxt);
...
// --- End of e2ap_RANfunctionStateControl_ItemIEs.c ---

// --- Begin of e2ap_RANfunctionStateControl_List.c ---
/*****************************************/
...
#endif
// --- End of e2ap_RANfunctionStateControl_List.c ---

/******************************************************************/
/* File .c missing: e2ap_RICsubscriptionStateControlRequest_IEs.c */
/******************************************************************/

// --- Begin of e2ap_RICsubscriptionStateControlRequest.c ---
...
// --- End of e2ap_RICsubscriptionStateControlRequest.c ---

// --- Begin of e2ap_RICsubscriptionStateControlRequest_protocolIEs.c ---
/******************************************************/
/*                                                    */
...
EXTERN int asn1PE_e2ap_RICsubscriptionStateControlRequest_protocolIEs (OSCTXT* pctxt, e2ap_RICsubscriptionStateControlRequest_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
...
// --- End of e2ap_RICsubscriptionStateControlRequest_protocolIEs.c ---

// --- Begin of e2ap_RICsubscriptionStateControlRequest_protocolIEs_element.c ---
/*****************************************/
...

    {
        ...
        switch(pvalue->id){//dungnm23 check case lai nhe
            ...
            asn1Init_e2ap_RICrequestID(pvalue->
                value.u._e2ap_RICsubscriptionStateControlRequest_IEs_id_RICrequestID);
            ...
            asn1Init_e2ap_RANfunctionStateControl_List(pvalue->
                value.u._e2ap_RICsubscriptionStateControlRequest_IEs_id_RANfunctionStateControl_List);
...
void asn1Free_e2ap_RICsubscriptionStateControlRequest_protocolIEs_element(OSCTXT* pctxt, e2ap_RICsubscriptionStateControlRequest_protocolIEs_element* pvalue)
{
    ...
    switch(pvalue->value.t){
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionStateControlRequest_IEs_id_RICrequestID:
            // rtxFreeE2ap_RICrequestID(pvalue->value.u._e2ap_RICsubscriptionStateControlRequest_IEs_id_RICrequestID);

            if(pvalue->value.i._e2ap_RICsubscriptionStateControlRequest_IEs_id_RICrequestID!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionStateControlRequest_IEs_id_RANfunctionStateControl_List:
            // rtxFreeE2ap_RANfunctionStateControl_List(pvalue->value.u._e2ap_RICsubscriptionStateControlRequest_IEs_id_RANfunctionStateControl_List);

            if(pvalue->value.i._e2ap_RICsubscriptionStateControlRequest_IEs_id_RANfunctionStateControl_List!=NULL){
    ...
    RTXCTXTPUSHELEMNAME(pctxt, "value");
        ...
        switch(pvalue->value.t){
            case T_E2AP_PDU_Contents_e2ap_RICsubscriptionStateControlRequest_IEs_id_RICrequestID:
            {
                ...
                stat = asn1PrtToStr_e2ap_RICrequestID (pctxt, pvalue->value.u._e2ap_RICsubscriptionStateControlRequest_IEs_id_RICrequestID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICsubscriptionStateControlRequest_IEs_id_RANfunctionStateControl_List:
            {
                RTXCTXTPUSHELEMNAME (pctxt, "RANfunctionStateControl-List");

                stat = asn1PrtToStr_e2ap_RANfunctionStateControl_List (pctxt, pvalue->value.u._e2ap_RICsubscriptionStateControlRequest_IEs_id_RANfunctionStateControl_List);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
...
#endif
// --- End of e2ap_RICsubscriptionStateControlRequest_protocolIEs_element.c ---
