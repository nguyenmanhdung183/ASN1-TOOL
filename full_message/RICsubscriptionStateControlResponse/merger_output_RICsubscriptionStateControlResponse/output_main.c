...
// --- Begin of e2ap_RICactionList_Item.c ---
...
// --- End of e2ap_RICactionList_Item.c ---

// --- Begin of e2ap_RICaction_ItemIEs.c ---
/* e2ap_RICaction_ItemIEs.c */
...
int asn1PE_e2ap_RICaction_ItemIEs (OSCTXT* pctxt, e2ap_RICaction_ItemIEs* pvalue)
{
   ...
   stat = asn1PE_e2ap_ProtocolIE_ID (pctxt, &pvalue->value.u_RICaction_ItemIEs_.id);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);

   /* encode criticality */
   RTXCTXTPUSHELEMNAME (pctxt, "criticality");
   stat = asn1PE_e2ap_Criticality (pctxt, &pvalue->value.u_RICaction_ItemIEs_.criticality);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);
...

   {
      ...
      case T_E2AP_PDU_Contents_RICaction_ItemIEs_RICactionList_Item:
         
         RTXCTXTPUSHELEMNAME (pctxt, "RICactionList_Item");
         stat = asn1PE_e2ap_RICactionList_Item (pctxt, pvalue->value.u._e2apRICaction_ItemIEs_RICactionList_Item);
         RTXCTXTPOPELEMNAME (pctxt);
...
// --- End of e2ap_RICaction_ItemIEs.c ---

// --- Begin of e2ap_RICaction_List.c ---
/*****************************************/
/*           RICaction_List                */
/*****************************************/
...
#endif
// --- End of e2ap_RICaction_List.c ---

// --- Begin of e2ap_RICsubscriptionList_Item.c ---
...
int asn1PE_e2ap_RICsubscriptionList_Item (OSCTXT* pctxt, e2ap_RICsubscriptionList_Item* pvalue)
{
   ...
   /* encode field ricAction_list */  
   if (pvalue->m_ricAction_listPresent) {
...
// --- End of e2ap_RICsubscriptionList_Item.c ---

// --- Begin of e2ap_RICsubscriptionList_ItemIEs.c ---
/* e2ap_RICsubscriptionList_ItemIEs.c */
...
int asn1PE_e2ap_RICsubscriptionList_ItemIEs (OSCTXT* pctxt, e2ap_RICsubscriptionList_ItemIEs* pvalue)
{
   ...
   /* encode id */
   RTXCTXTPUSHELEMNAME (pctxt, "id");
   stat = asn1PE_e2ap_ProtocolIE_ID (pctxt, &pvalue->value.u_RICsubscriptionList_ItemIEs_.id);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);

   /* encode criticality */
   RTXCTXTPUSHELEMNAME (pctxt, "criticality");
   stat = asn1PE_e2ap_Criticality (pctxt, &pvalue->value.u_RICsubscriptionList_ItemIEs_.criticality);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);
...

   {
      ...
      switch (pvalue->value.t) {
      case T_E2AP_PDU_Contents_RICsubscriptionList_ItemIEs_RICsubscriptionList_Item:
         
         RTXCTXTPUSHELEMNAME (pctxt, "RICsubscriptionList_Item");
         stat = asn1PE_e2ap_RICsubscriptionList_Item (pctxt, pvalue->value.u._e2apRICsubscriptionList_ItemIEs_RICsubscriptionList_Item);
         RTXCTXTPOPELEMNAME (pctxt);
...
// --- End of e2ap_RICsubscriptionList_ItemIEs.c ---

// --- Begin of e2ap_RICsubscriptionSuspended_List.c ---
/*****************************************/
...
#endif
// --- End of e2ap_RICsubscriptionSuspended_List.c ---

// --- Begin of e2ap_RICsubscriptionResumed_List.c ---
/*****************************************/
...
#endif
// --- End of e2ap_RICsubscriptionResumed_List.c ---

// --- Begin of e2ap_RANfunctionStateConfirm_Item.c ---
...
int asn1PE_e2ap_RANfunctionStateConfirm_Item (OSCTXT* pctxt, e2ap_RANfunctionStateConfirm_Item* pvalue)
{
   ...
   /* encode field ricSubscriptionSuspended_list */  
   if (pvalue->m_ricSubscriptionSuspended_listPresent) {
   ...
   /* encode field ricSubscriptionResumed_list */  
   if (pvalue->m_ricSubscriptionResumed_listPresent) {
...
// --- End of e2ap_RANfunctionStateConfirm_Item.c ---

// --- Begin of e2ap_RANfunctionStateConfirm_ItemIEs.c ---
/* e2ap_RANfunctionStateConfirm_ItemIEs.c */
...
int asn1PE_e2ap_RANfunctionStateConfirm_ItemIEs (OSCTXT* pctxt, e2ap_RANfunctionStateConfirm_ItemIEs* pvalue)
{
   ...
   /* encode id */
   RTXCTXTPUSHELEMNAME (pctxt, "id");
   stat = asn1PE_e2ap_ProtocolIE_ID (pctxt, &pvalue->value.u_RANfunctionStateConfirm_ItemIEs_.id);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);

   /* encode criticality */
   RTXCTXTPUSHELEMNAME (pctxt, "criticality");
   stat = asn1PE_e2ap_Criticality (pctxt, &pvalue->value.u_RANfunctionStateConfirm_ItemIEs_.criticality);
   if (stat != 0) return LOG_RTERR (pctxt, stat);
   RTXCTXTPOPELEMNAME (pctxt);
...

   {
      ...
      switch (pvalue->value.t) {
      case T_E2AP_PDU_Contents_RANfunctionStateConfirm_ItemIEs_RANfunctionStateConfirm_Item:
         
         RTXCTXTPUSHELEMNAME (pctxt, "RANfunctionStateConfirm_Item");
         stat = asn1PE_e2ap_RANfunctionStateConfirm_Item (pctxt, pvalue->value.u._e2apRANfunctionStateConfirm_ItemIEs_RANfunctionStateConfirm_Item);
         RTXCTXTPOPELEMNAME (pctxt);
...
// --- End of e2ap_RANfunctionStateConfirm_ItemIEs.c ---

// --- Begin of e2ap_RANfunctionStateConfirm_List.c ---
/*****************************************/
...
#endif
// --- End of e2ap_RANfunctionStateConfirm_List.c ---

/*******************************************************************/
/* File .c missing: e2ap_RICsubscriptionStateControlResponse_IEs.c */
/*******************************************************************/

// --- Begin of e2ap_RICsubscriptionStateControlResponse.c ---
...
// --- End of e2ap_RICsubscriptionStateControlResponse.c ---

// --- Begin of e2ap_RICsubscriptionStateControlResponse_protocolIEs.c ---
/******************************************************/
/*                                                    */
/*    RICsubscriptionStateControlResponse_protocolIEs                      */
/*                                                    */
/******************************************************/
//ie big msg

EXTERN int asn1PE_e2ap_RICsubscriptionStateControlResponse_protocolIEs (OSCTXT* pctxt, e2ap_RICsubscriptionStateControlResponse_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
...
// --- End of e2ap_RICsubscriptionStateControlResponse_protocolIEs.c ---

// --- Begin of e2ap_RICsubscriptionStateControlResponse_protocolIEs_element.c ---
/*****************************************/
/*    RICsubscriptionStateControlResponse_protocolIEs_element     */
/*****************************************/
...

    {
        ...
        switch(pvalue->id){//dungnm23 check case lai nhe
            ...
            asn1Init_e2ap_RICrequestID(pvalue->
                value.u._e2ap_RICsubscriptionStateControlResponse_IEs_id_RICrequestID);
            ...
            asn1Init_e2ap_RANfunctionStateConfirm_List(pvalue->
                value.u._e2ap_RICsubscriptionStateControlResponse_IEs_id_RANfunctionStateConfirm_List);
...
void asn1Free_e2ap_RICsubscriptionStateControlResponse_protocolIEs_element(OSCTXT* pctxt, e2ap_RICsubscriptionStateControlResponse_protocolIEs_element* pvalue)
{
    ...
    switch(pvalue->value.t){
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionStateControlResponse_IEs_id_RICrequestID:
            // rtxFreeE2ap_RICrequestID(pvalue->value.u._e2ap_RICsubscriptionStateControlResponse_IEs_id_RICrequestID);

            if(pvalue->value.i._e2ap_RICsubscriptionStateControlResponse_IEs_id_RICrequestID!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_RICsubscriptionStateControlResponse_IEs_id_RANfunctionStateConfirm_List:
            // rtxFreeE2ap_RANfunctionStateConfirm_List(pvalue->value.u._e2ap_RICsubscriptionStateControlResponse_IEs_id_RANfunctionStateConfirm_List);

            if(pvalue->value.i._e2ap_RICsubscriptionStateControlResponse_IEs_id_RANfunctionStateConfirm_List!=NULL){
    ...
    RTXCTXTPUSHELEMNAME(pctxt, "value");
        ...
        switch(pvalue->value.t){
            case T_E2AP_PDU_Contents_e2ap_RICsubscriptionStateControlResponse_IEs_id_RICrequestID:
            {
                ...
                stat = asn1PrtToStr_e2ap_RICrequestID (pctxt, pvalue->value.u._e2ap_RICsubscriptionStateControlResponse_IEs_id_RICrequestID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_RICsubscriptionStateControlResponse_IEs_id_RANfunctionStateConfirm_List:
            {
                RTXCTXTPUSHELEMNAME (pctxt, "RANfunctionStateConfirm-List");

                stat = asn1PrtToStr_e2ap_RANfunctionStateConfirm_List (pctxt, pvalue->value.u._e2ap_RICsubscriptionStateControlResponse_IEs_id_RANfunctionStateConfirm_List);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
...
#endif
// --- End of e2ap_RICsubscriptionStateControlResponse_protocolIEs_element.c ---
