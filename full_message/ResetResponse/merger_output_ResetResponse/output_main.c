...
/********************************************/
/* File .c missing: e2ap_ResetResponseIEs.c */
/********************************************/

// --- Begin of e2ap_ResetResponse.c ---
...
// --- End of e2ap_ResetResponse.c ---

// --- Begin of e2ap_ResetResponse_protocolIEs.c ---
/******************************************************/
/*                                                    */
...
EXTERN int asn1PE_e2ap_ResetResponse_protocolIEs (OSCTXT* pctxt, e2ap_ResetResponse_protocolIEst* pvalue)
{
    int stat =0;
    OSRTDListNode* pnode;
    OSUINT32 xx1;
...
// --- End of e2ap_ResetResponse_protocolIEs.c ---

// --- Begin of e2ap_ResetResponse_protocolIEs_element.c ---
/*****************************************/
...

    {
        ...
        switch(pvalue->id){//dungnm23 check case lai nhe
            ...
            asn1Init_e2ap_TransactionID(pvalue->
                value.u._e2ap_ResetResponseIEs_id_TransactionID);
            ...
            asn1Init_e2ap_CriticalityDiagnostics(pvalue->
                value.u._e2ap_ResetResponseIEs_id_CriticalityDiagnostics);
...
void asn1Free_e2ap_ResetResponse_protocolIEs_element(OSCTXT* pctxt, e2ap_ResetResponse_protocolIEs_element* pvalue)
{
    ...
    switch(pvalue->value.t){
        case T_E2AP_PDU_Contents_e2ap_ResetResponseIEs_id_TransactionID:
            // rtxFreeE2ap_TransactionID(pvalue->value.u._e2ap_ResetResponseIEs_id_TransactionID);

            if(pvalue->value.i._e2ap_ResetResponseIEs_id_TransactionID!=NULL){
            ...
            break;
        case T_E2AP_PDU_Contents_e2ap_ResetResponseIEs_id_CriticalityDiagnostics:
            // rtxFreeE2ap_CriticalityDiagnostics(pvalue->value.u._e2ap_ResetResponseIEs_id_CriticalityDiagnostics);

            if(pvalue->value.i._e2ap_ResetResponseIEs_id_CriticalityDiagnostics!=NULL){
    ...
    RTXCTXTPUSHELEMNAME(pctxt, "value");
        ...
        switch(pvalue->value.t){
            case T_E2AP_PDU_Contents_e2ap_ResetResponseIEs_id_TransactionID:
            {
                ...
                stat = asn1PrtToStr_e2ap_TransactionID (pctxt, pvalue->value.u._e2ap_ResetResponseIEs_id_TransactionID);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
            ...
            case T_E2AP_PDU_Contents_e2ap_ResetResponseIEs_id_CriticalityDiagnostics:
            {
                ...
                stat = asn1PrtToStr_e2ap_CriticalityDiagnostics (pctxt, pvalue->value.u._e2ap_ResetResponseIEs_id_CriticalityDiagnostics);
                if (stat != 0) return LOG_RTERR (pctxt, stat);
...
#endif
// --- End of e2ap_ResetResponse_protocolIEs_element.c ---
