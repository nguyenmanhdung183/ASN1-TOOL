...
int asn1PE_e2ap_E2connectionUpdate-Item (OSCTXT* pctxt, e2ap_E2connectionUpdate-Item* pvalue)
{
   int stat = 0;
   //RTXCTXTPUSHTYPENAME (pctxt, "E2connectionUpdate-Item");
...

   {
      ...
      case T_E2AP_PDU_Contents_e2ap_E2connectionUpdate-Item_E2connectionUpdate_Item:
         
         RTXCTXTPUSHELEMNAME (pctxt, "_e2ap_E2connectionUpdate-Item_id_E2connectionUpdate_Item");
         stat = asn1PE_e2ap_E2connectionUpdate_Item (pctxt, pvalue->value.u._e2apE2connectionUpdate-Item_E2connectionUpdate_Item);
         RTXCTXTPOPELEMNAME (pctxt);
      
         break;

      case T_E2AP_PDU_Contents_e2ap_E2connectionUpdate-Item_UNDEF_:
      {
...
int asn1PD_e2ap_E2connectionUpdate-Item (OSCTXT* pctxt, e2ap_E2connectionUpdate-Item* pvalue)
{
   /* decode logic tương tự, có switch + openType */
   return 0;
}

void asn1Init_e2ap_E2connectionUpdate-Item (e2ap_E2connectionUpdate-Item* pvalue)
{
   if (!pvalue) return;
   OSCRTLMEMSET (pvalue, 0, sizeof(e2ap_E2connectionUpdate-Item));
}

#if 0
void asn1Free_e2ap_E2connectionUpdate-Item (OSCTXT* pctxt, e2ap_E2connectionUpdate-Item* pvalue)
{
   if (!pvalue) return;
   if (pvalue->extElem1) {
...
void asn1Free_e2ap_E2connectionUpdate-Item (OSCTXT* pctxt, e2ap_E2connectionUpdate-Item* pvalue)
{
   ...
   switch(pvalue->value.t){
      case T_E2AP_PDU_Contents_e2ap_E2connectionUpdate-Item_E2connectionUpdate_Item:
         asn1Free_e2ap_E2connectionUpdate_Item (pctxt, pvalue->value.u._e2apE2connectionUpdate-Item_E2connectionUpdate_Item);
         rtxMemFreePtr(pctxt, (void*)pvalue->value.u._e2apE2connectionUpdate-Item_E2connectionUpdate_Item);
         pvalue->value.u._e2apE2connectionUpdate-Item_E2connectionUpdate_Item = 0;
         break;
      case T_E2AP_PDU_Contents_e2ap_E2connectionUpdate-Item_UNDEF_:
         if(0!=pvalue->value.u.extElem1){
...
int asn1PE_e2ap_E2connectionUpdateRemove-Item (OSCTXT* pctxt, e2ap_E2connectionUpdateRemove-Item* pvalue)
{
   int stat = 0;
   //RTXCTXTPUSHTYPENAME (pctxt, "E2connectionUpdateRemove-Item");
...

   {
      ...
      switch (pvalue->value.t) {
      case T_E2AP_PDU_Contents_e2ap_E2connectionUpdateRemove-Item_E2connectionUpdateRemove_Item:
         
         RTXCTXTPUSHELEMNAME (pctxt, "_e2ap_E2connectionUpdateRemove-Item_id_E2connectionUpdateRemove_Item");
         stat = asn1PE_e2ap_E2connectionUpdateRemove_Item (pctxt, pvalue->value.u._e2apE2connectionUpdateRemove-Item_E2connectionUpdateRemove_Item);
         RTXCTXTPOPELEMNAME (pctxt);
      
         break;

      case T_E2AP_PDU_Contents_e2ap_E2connectionUpdateRemove-Item_UNDEF_:
      {
          if(0!=pvalue->value.u.extElem1){
              openType.numocts = pvalue->value.u.extElem1->numocts;
              openType.data = pvalue->value.u.extElem1->data;
...
int asn1PD_e2ap_E2connectionUpdateRemove-Item (OSCTXT* pctxt, e2ap_E2connectionUpdateRemove-Item* pvalue)
{
   /* decode logic tương tự, có switch + openType */
   return 0;
}

void asn1Init_e2ap_E2connectionUpdateRemove-Item (e2ap_E2connectionUpdateRemove-Item* pvalue)
{
   if (!pvalue) return;
   OSCRTLMEMSET (pvalue, 0, sizeof(e2ap_E2connectionUpdateRemove-Item));
}

#if 0
void asn1Free_e2ap_E2connectionUpdateRemove-Item (OSCTXT* pctxt, e2ap_E2connectionUpdateRemove-Item* pvalue)
{
   if (!pvalue) return;
   if (pvalue->extElem1) {
      rtxMemFreeArray (pctxt, pvalue->extElem1);
...
void asn1Free_e2ap_E2connectionUpdateRemove-Item (OSCTXT* pctxt, e2ap_E2connectionUpdateRemove-Item* pvalue)
{
   ...
   switch(pvalue->value.t){
      case T_E2AP_PDU_Contents_e2ap_E2connectionUpdateRemove-Item_E2connectionUpdateRemove_Item:
         asn1Free_e2ap_E2connectionUpdateRemove_Item (pctxt, pvalue->value.u._e2apE2connectionUpdateRemove-Item_E2connectionUpdateRemove_Item);
         rtxMemFreePtr(pctxt, (void*)pvalue->value.u._e2apE2connectionUpdateRemove-Item_E2connectionUpdateRemove_Item);
         pvalue->value.u._e2apE2connectionUpdateRemove-Item_E2connectionUpdateRemove_Item = 0;
         break;
      case T_E2AP_PDU_Contents_e2ap_E2connectionUpdateRemove-Item_UNDEF_:
         if(0!=pvalue->value.u.extElem1){
             rtxMemFreePtr(pctxt, pvalue->value.u.extElem1->data);
