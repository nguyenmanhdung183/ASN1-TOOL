...
typedef struct EXTERN e2ap_E2setupRequest_protocolIEs_element {
   ...
   struct{
      ...
      union {
        ...
        *presence: MANDATORY
        */
        e2ap_TransactionID *_e2apE2setupRequest_id_TransactionID,
        ...
        *presence: MANDATORY
        */
        e2ap_GlobalE2node_ID *_e2apE2setupRequest_id_GlobalE2node_ID,
        ...
        *presence: MANDATORY
        */
        e2ap_RANfunctions_List *_e2apE2setupRequest_id_RANfunctions_List,
        ...
        *presence: MANDATORY
        */
        e2ap_E2nodeComponentConfigAddition_List *_e2apE2setupRequest_id_E2nodeComponentConfigAddition_List
