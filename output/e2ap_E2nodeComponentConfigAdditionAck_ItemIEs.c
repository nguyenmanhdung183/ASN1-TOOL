...
{
   int stat = 0;
   RTXCTXPUSHTYPENAME (pctxt, "E2nodeComponentConfigAdditionAck_ItemIEs");
...

   {
      ...
      switch (pvalue->value.t) {
         case T_E2AP_PDU_Contents_E2nodeComponentConfigAdditionAck_ItemIEs_:
            ...
            stat = asn1PE_e2ap_E2nodeComponentConfigAdditionAck-Item (pctxt, &pvalue->value.u_E2nodeComponentConfigAdditionAck_ItemIEs_.value);
            if (stat != 0) return LOG_RTERR (pctxt, stat);
            RTXCTXPOPELEMNAME (pctxt);
            break;
