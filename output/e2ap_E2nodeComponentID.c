...
EXTERN int asn1PE_e2ap_E2nodeComponentID (OSCTXT* pctxt, e2ap_E2nodeComponentID* pvalue)
{
   ...
   switch (pvalue->t) {
      case 1:
         ...
         stat = pe_BitString32 (pctxt, pvalue->u.e2nodeComponentInterfaceTypeNG, OSUINTCONST(), OSUINTCONST());//not primitive
      ...
      case 2:
         ...
         PU_SETSIZECONSTRAINT(pctxt, OSUINTCONST(), OSUINTCONST(), 0, 0);
         stat = pe_BitString32 (pctxt, pvalue->u.e2nodeComponentInterfaceTypeXn, OSUINTCONST(), OSUINTCONST());//not primitive
      ...
      case 3:
         ...
         PU_SETSIZECONSTRAINT(pctxt, OSUINTCONST(), OSUINTCONST(), 0, 0);
         stat = pe_BitString32 (pctxt, pvalue->u.e2nodeComponentInterfaceTypeE1, OSUINTCONST(), OSUINTCONST());//not primitive
      ...
      case 4:
         ...
         PU_SETSIZECONSTRAINT(pctxt, OSUINTCONST(), OSUINTCONST(), 0, 0);
         stat = pe_BitString32 (pctxt, pvalue->u.e2nodeComponentInterfaceTypeF1, OSUINTCONST(), OSUINTCONST());//not primitive
      ...
      case 5:
         ...
         PU_SETSIZECONSTRAINT(pctxt, OSUINTCONST(), OSUINTCONST(), 0, 0);
         stat = pe_BitString32 (pctxt, pvalue->u.e2nodeComponentInterfaceTypeW1, OSUINTCONST(), OSUINTCONST());//not primitive
      ...
      case 6:
         ...
         PU_SETSIZECONSTRAINT(pctxt, OSUINTCONST(), OSUINTCONST(), 0, 0);
         stat = pe_BitString32 (pctxt, pvalue->u.e2nodeComponentInterfaceTypeS1, OSUINTCONST(), OSUINTCONST());//not primitive
      ...
      case 7:
         ...
         PU_SETSIZECONSTRAINT(pctxt, OSUINTCONST(), OSUINTCONST(), 0, 0);
         stat = pe_BitString32 (pctxt, pvalue->u.e2nodeComponentInterfaceTypeX2, OSUINTCONST(), OSUINTCONST());//not primitive
