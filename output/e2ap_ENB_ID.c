...
EXTERN int asn1PE_e2ap_ENB_ID (OSCTXT* pctxt, e2ap_ENB_ID* pvalue)
{
   ...
   switch (pvalue->t) {
      case 1:
         ...
         stat = asn1PE_e2ap_ENB_ID_macro_eNB_ID (pctxt, pvalue->u.macro_eNB_ID);// primitive
      ...
      case 2:
         ...
         stat = asn1PE_e2ap_ENB_ID_home_eNB_ID (pctxt, pvalue->u.home_eNB_ID);// primitive
      ...
      case 3:
         ...
         stat = asn1PE_e2ap_ENB_ID_short_Macro_eNB_ID (pctxt, pvalue->u.short_Macro_eNB_ID);// primitive
      ...
      case 4:
         ...
         stat = asn1PE_e2ap_ENB_ID_long_Macro_eNB_ID (pctxt, pvalue->u.long_Macro_eNB_ID);// primitive
...
int asn1PrtToStr_e2ap_ENB_ID (const char* name, e2ap_ENB_ID* pvalue, char* buffer, OSSIZE bufSize)
{
   ...
   switch (pvalue->t) {
      case T_e2ap_ENB_ID_macro_eNB_ID:
         //primitive BIT STRING
         if (asn1PrtToStr_e2ap_ENB_ID_macro_eNB_ID ( "macro_eNB_ID", pvalue->u.macro_eNB_ID, buffer, bufSize) < 0) return -1;
         break;
      case T_e2ap_ENB_ID_home_eNB_ID:
         //primitive BIT STRING
         if (asn1PrtToStr_e2ap_ENB_ID_home_eNB_ID ( "home_eNB_ID", pvalue->u.home_eNB_ID, buffer, bufSize) < 0) return -1;
         break;
      case T_e2ap_ENB_ID_short_Macro_eNB_ID:
         //primitive BIT STRING
         if (asn1PrtToStr_e2ap_ENB_ID_short_Macro_eNB_ID ( "short_Macro_eNB_ID", pvalue->u.short_Macro_eNB_ID, buffer, bufSize) < 0) return -1;
         break;
      case T_e2ap_ENB_ID_long_Macro_eNB_ID:
         //primitive BIT STRING
         if (asn1PrtToStr_e2ap_ENB_ID_long_Macro_eNB_ID ( "long_Macro_eNB_ID", pvalue->u.long_Macro_eNB_ID, buffer, bufSize) < 0) return -1;
         break;
      default:
         return RTERR_INVOPT;
   }
   ...
   switch (pvalue->t) {
      ...
      case 1:
         if (pvalue->u.macro_eNB_ID) {
            //primitive BIT STRING
            asn1Free_e2ap_ENB_ID_macro_eNB_ID (pctxt, pvalue->u.macro_eNB_ID);
      ...
      case 2:
         if (pvalue->u.home_eNB_ID) {
            //primitive BIT STRING
            asn1Free_e2ap_ENB_ID_home_eNB_ID (pctxt, pvalue->u.home_eNB_ID);
      ...
      case 3:
         if (pvalue->u.short_Macro_eNB_ID) {
            //primitive BIT STRING
            asn1Free_e2ap_ENB_ID_short_Macro_eNB_ID (pctxt, pvalue->u.short_Macro_eNB_ID);
      ...
      case 4:
         if (pvalue->u.long_Macro_eNB_ID) {
            //primitive BIT STRING
            asn1Free_e2ap_ENB_ID_long_Macro_eNB_ID (pctxt, pvalue->u.long_Macro_eNB_ID);
