...
EXTERN int asn1PE_e2ap_GNB_ID_Choice (OSCTXT* pctxt, e2ap_GNB_ID_Choice* pvalue)
{
   ...
   switch (pvalue->t) {
      case 1:
         ...
         stat = asn1PE_e2ap_GNB_ID_Choice_gnb_ID (pctxt, pvalue->u.gnb_ID);// primitive
...
int asn1PrtToStr_e2ap_GNB_ID_Choice (const char* name, e2ap_GNB_ID_Choice* pvalue, char* buffer, OSSIZE bufSize)
{
   ...
   switch (pvalue->t) {
      case T_e2ap_GNB_ID_Choice_gnb_ID:
         //primitive BIT STRING
         if (asn1PrtToStr_e2ap_GNB_ID_Choice_gnb_ID ( "gnb_ID", pvalue->u.gnb_ID, buffer, bufSize) < 0) return -1;
         break;
      default:
         return RTERR_INVOPT;
   }
...
void asn1Free_e2ap_GNB_ID_Choice (OSCTXT* pctxt, e2ap_GNB_ID_Choice* pvalue)
{
   ...
   switch (pvalue->t) {
      ...
      case 1:
         if (pvalue->u.gnb_ID) {
            //primitive BIT STRING
            asn1Free_e2ap_GNB_ID_Choice_gnb_ID (pctxt, pvalue->u.gnb_ID);
