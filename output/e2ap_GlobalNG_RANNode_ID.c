...
EXTERN int asn1PE_e2ap_GlobalNG_RANNode_ID (OSCTXT* pctxt, e2ap_GlobalNG_RANNode_ID* pvalue)
{
   ...
   switch (pvalue->t) {
      case 1:
         ...
         stat = pe_BitString32 (pctxt, pvalue->u.gNB, OSUINTCONST(), OSUINTCONST());//not primitive
      ...
      case 2:
         ...
         PU_SETSIZECONSTRAINT(pctxt, OSUINTCONST(), OSUINTCONST(), 0, 0);
         stat = pe_BitString32 (pctxt, pvalue->u.ng_eNB, OSUINTCONST(), OSUINTCONST());//not primitive
