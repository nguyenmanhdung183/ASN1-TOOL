...
EXTERN void asn1Print_e2ap_ProtocolIE_ID (const char* name, const e2ap_ProtocolIE_ID* pvalue);
EXTERN int asn1PrtToStr_e2ap_ProtocolIE_ID (const char* name, e2ap_ProtocolIE_ID* pvalue, char* buffer, OSSIZE bufSize);
EXTERN int asn1PrtToStrm_e2ap_ProtocolIE_ID (OSCTXT* pctxt, const char* name, const e2ap_ProtocolIE_ID* pvalue);